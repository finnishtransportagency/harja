...
date    : Year-Month-Day  : optional : Notices are automatically arranged by date. If date field is left out notice is pushed to the end of list
title   : text            : optional : Default title will be used if left out
short   : text            : optional
body    : text            : optional : Can be left out but that makes no sense
