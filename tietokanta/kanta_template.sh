...
mvn clean compile -Pharja_template flyway:migrate

PGOPTIONS='--client-min-messages=warning' $psql -p5432 harja_template -X -q -a -l -v ON_ERROR_STOP=1 --pset pager=off -f testidata.sql
