...
VALUES ((SELECT id
      ...
      ((SELECT id
       ...
       ((SELECT id
           FROM yllapitokohde
          WHERE nimi = 'Tärkeä kohde mt20'), 'Tärkeä kohdeosa kaista 11', 20, 1, 1, 1, 3000, 0, 11, ST_GeomFromText(
       ...
       ((SELECT id
           FROM yllapitokohde
          WHERE nimi = 'Tärkeä kohde mt20'), 'Tärkeä kohdeosa kaista 21', 20, 1, 1, 1, 3000, 0, 21, ST_GeomFromText(
       ...
       ((SELECT id
           FROM yllapitokohde
          WHERE nimi = 'Aloittamaton kohde mt20'), 'Kohdeosa kaista 11', 20, 1, 3, 1, 5000, 0, 11, ST_GeomFromText(
       ...
       ((SELECT id
           FROM yllapitokohde
          WHERE nimi = 'Aloittamaton kohde mt20'), 'Kohdeosa kaista 21', 20, 1, 3, 1, 5000, 0, 21, ST_GeomFromText(
