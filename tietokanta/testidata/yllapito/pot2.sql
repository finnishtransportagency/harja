...
-- kulutuskerros (= järj.nro 1 DEFAULT)
    ...
    INSERT INTO pot2_paallystekerros (kohdeosa_id, toimenpide, materiaali, leveys, pinta_ala, kokonaismassamaara, piennar, lisatieto, pot2_id, jarjestysnro, massamenekki) VALUES ((SELECT id FROM yllapitokohdeosa WHERE nimi = 'Pottilan AB-levityskohde osa 1'), 12, 3, 2.00, 398, 34, false, null, 7, 1, 85.4);

    INSERT INTO pot2_alusta (tr_numero, tr_alkuetaisyys, tr_alkuosa, tr_loppuetaisyys, tr_loppuosa, tr_ajorata, tr_kaista, toimenpide, pot2_id, poistettu, verkon_tyyppi, verkon_tarkoitus, verkon_sijainti, lisatty_paksuus, massamenekki, murske, kasittelysyvyys, leveys, pinta_ala, kokonaismassamaara, massa, sideaine, sideainepitoisuus, sideaine2) VALUES (4, 1, 101, 200, 101, 1, 11, 23, (SELECT id FROM paallystysilmoitus WHERE paallystyskohde = (SELECT id FROM yllapitokohde WHERE nimi = 'Pottilan AB-levityskohde')), false, null, null, null, 5, null, 2, null, null, null, null, null, null, null, null);
...
WITH urakka AS (INSERT INTO urakka (sampoid, sopimustyyppi, hallintayksikko, nimi, alkupvm, loppupvm,
    ...
    VALUES ('5731290-TES2', 'kokonaisurakka' :: sopimustyyppi, (SELECT id
     ...
     murske AS (
         INSERT INTO pot2_mk_urakan_murske (urakka_id, nimen_tarkenne, tyyppi, esiintyma, rakeisuus, "iskunkestavyys", dop_nro, poistettu, muokkaaja, muokattu, luoja, luotu)
             SELECT urakka.id,
                    'LJYR',
                    1,
                    'Tonkkulan Kaivo',
     ...
     paikkauskohteet AS (
         INSERT INTO paikkauskohde ("ulkoinen-id", nimi, poistettu, luotu, muokattu,
             ...
             SELECT 1,
                    'MT 86 Paavolantie',
                    FALSE,
                    '2024-12-01T12:00:00.000'::TIMESTAMP,
                    '2024-12-02T12:00:00.000'::TIMESTAMP,
                    urakka.id,
     ...
     paikkaus AS (
         INSERT INTO paikkaus (luotu, muokattu, "urakka-id", "paikkauskohde-id", "ulkoinen-id", alkuaika, loppuaika,
                               ...
                               massamenekki)
             SELECT '2024-12-01T12:00:00'::DATE,
                    '2024-12-02T13:00:00'::TIMESTAMP,
                    urakka.id,
                    paikkauskohteet.id,
                    0,
                    '2024-12-02T12:00:00'::TIMESTAMP,
                    '2024-12-02T13:00:00'::TIMESTAMP,
