...
WITH urakka AS (INSERT INTO urakka (sampoid, sopimustyyppi, hallintayksikko, nimi, alkupvm, loppupvm,
    ...
    VALUES ('5731290-TES2', 'kokonaisurakka' :: sopimustyyppi, (SELECT id
            ...
            '2022-01-01', '2022-12-31', 'paallystys', 'testitunnus', (SELECT id
                                                                       FROM organisaatio
     ...
     paikkauskohteet AS (
         INSERT INTO paikkauskohde ("ulkoinen-id", nimi, poistettu, luotu, muokattu,
             ...
             SELECT 1,
                    'MT 86 Paavolantie',
                    FALSE,
                    '2022-12-01T12:00:00.000'::TIMESTAMP,
                    '2022-12-02T12:00:00.000'::TIMESTAMP,
                    urakka.id,
     ...
     paikkaus AS (
         INSERT INTO paikkaus (luotu, muokattu, "urakka-id", "paikkauskohde-id", "ulkoinen-id", alkuaika, loppuaika,
                               ...
                               massamenekki)
             SELECT '2022-12-01T12:00:00'::DATE,
                    '2022-12-02T13:00:00'::TIMESTAMP,
                    urakka.id,
                    paikkauskohteet.id,
                    0,
                    '2022-12-02T12:00:00'::TIMESTAMP,
                    '2022-12-02T13:00:00'::TIMESTAMP,
