...
VALUES
  ((SELECT id from toteuma where lisatieto = 'VANlyv_yht_tot1'), '2015-01-19 00:00.00', (SELECT id FROM tehtava WHERE    nimi='Is 2-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'VANlyv_yht_tot1')),
  ((SELECT id from toteuma where lisatieto = 'VANlyv_yht_tot2'), '2015-01-19 00:00.00', (SELECT id FROM tehtava WHERE    nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'VANlyv_yht_tot2')),
  ((SELECT id from toteuma where lisatieto = 'VANlyv_yht_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE    nimi='Is 2-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'VANlyv_yht_tot_heinakuu')),
  ((SELECT id from toteuma where lisatieto = 'VANlyv_yht_tot_elokuu_eka'), '2015-08-02 00:00.00', (SELECT id FROM tehtava WHERE    nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'VANlyv_yht_tot_elokuu_eka')),
