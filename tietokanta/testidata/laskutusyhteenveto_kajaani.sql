...
INSERT INTO kokonaishintainen_tyo (vuosi,kuukausi,summa,maksupvm,toimenpideinstanssi,sopimus)
VALUES (2015, 10, 3500, '2015-10-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2015, 11, 3500, '2015-11-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2015, 12, 3500, '2015-12-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 1, 3500, '2016-01-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 2, 3500, '2016-02-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 3, 3500, '2016-03-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 4, 3500, '2016-04-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 5, 3500, '2016-05-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 6, 3500, '2016-06-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 7, 3500, '2016-07-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 8, 3500, '2016-08-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 9, 3500, '2016-09-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2015, 10, 10000, '2015-10-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2015, 11, 10000, '2015-11-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2015, 12, 10000, '2015-12-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 1, 10000, '2016-01-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 2, 10000, '2016-02-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 3, 10000, '2016-03-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 4, 10000, '2016-04-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 5, 10000, '2016-05-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 6, 10000, '2016-06-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 7, 10000, '2016-07-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  (2016, 8, 10000, '2016-08-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
  -- Lisäsopimuksesta kokonaishintaista työtä mukaan myös
  (2016, 9, 10, '2016-09-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS NOT null)),
  (2016, 9, 10000, '2016-09-15', (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Sorateiden hoito TP 2014-2019'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null));

INSERT INTO yksikkohintainen_tyo (alkupvm, loppupvm, maara, yksikko, yksikkohinta, tehtava, urakka, sopimus)
    VALUES ('2014-10-01', '2014-12-31', 3, 'km', 100, (SELECT id FROM tehtava WHERE nimi='Is 2-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
           ('2015-01-01', '2015-09-30', 9, 'km', 100, (SELECT id FROM tehtava WHERE nimi='Is 2-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
           ('2014-10-01', '2014-12-31', 60, 'ha', 100, (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
           ('2015-01-01', '2015-09-30', 180, 'ha', 100, (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null));
...
VALUES ((SELECT alkupvm FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT loppupvm FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), 'tiekm', 100.0, (SELECT id FROM tehtava WHERE nimi='Is 1-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
       ((SELECT alkupvm FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT loppupvm FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), 'ha', 100.0, (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus/ha'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null));
...
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto)
     VALUES ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
             ...
             'kokonaishintainen'::toteumatyyppi, 'Seppo Suorittaja', '4153724-6', 'KAJ-LYV-toteuma');
INSERT INTO toteuma_materiaali (toteuma, luotu, materiaalikoodi, maara, urakka_id, hoitokauden_alkuvuosi)
    VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'KAJ-LYV-toteuma'), '2015-02-19 10:23:54+02',
            (SELECT id FROM materiaalikoodi WHERE nimi='Talvisuolaliuos NaCl'), 2000, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), 2014);

INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto)
VALUES ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
       (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
        '2015-01-19 10:23:54+02', '2015-01-19 10:23:54+02', '2015-01-19 10:23:54+02', 'yksikkohintainen'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_yht_tot1'),
       ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
        (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
        '2015-01-19 10:23:54+02', '2015-01-19 10:23:54+02', '2015-01-19 10:23:54+02', 'yksikkohintainen'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_yht_tot2'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-07-19 10:23:54+02', '2015-07-19 10:23:54+02', '2015-07-19 10:23:54+02', 'yksikkohintainen'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_yht_tot_heinakuu'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-01 00:00:00+02', '2015-08-01 00:00:00+02', '2015-08-01 00:00:00+02', 'yksikkohintainen'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_yht_tot_elokuu_eka'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-19 10:23:54+02', '2015-08-19 10:23:54+02', '2015-08-19 10:23:54+02', 'yksikkohintainen'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_yht_tot_elokuu'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-20 10:23:54+02', '2015-08-20 10:23:54+02', '2015-08-20 10:23:54+02', 'yksikkohintainen'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_yht_tot_elokuu2'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-07-19 10:23:54+02', '2015-07-19 10:23:54+02', '2015-07-19 10:23:54+02', 'muutostyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_muutostyo_tot_heinakuu'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-07-12 10:23:54+02', '2015-07-12 10:23:54+02', '2015-07-12 10:23:54+02', 'muutostyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_muutostyo_tot_heinakuu_paivanhinta'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-01 00:00:00+02', '2015-08-01 00:00:00+02', '2015-08-01 00:00:00+02', 'muutostyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_muutostyo_tot_elokuu_eka'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-01 00:00:00+02', '2015-08-01 00:00:00+02', '2015-08-01 00:00:00+02', 'muutostyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_muutostyo_tot_elokuu_eka_paivanhinta'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-19 10:23:54+02', '2015-08-19 10:23:54+02', '2015-08-19 10:23:54+02', 'lisatyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_lisatyo_tot_elokuu'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-10 10:23:54+02', '2015-08-10 10:23:54+02', '2015-08-10 10:23:54+02', 'lisatyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_1'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-20 10:23:54+02', '2015-08-20 10:23:54+02', '2015-08-20 10:23:54+02', 'lisatyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_2'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-07-22 10:23:54+02', '2015-07-20 10:23:54+02', '2015-07-20 10:23:54+02', 'akillinen-hoitotyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_akillinen_tot_heinakuu'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-22 10:23:54+02', '2015-08-20 10:23:54+02', '2015-08-20 10:23:54+02', 'akillinen-hoitotyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_akillinen_tot_elokuu'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-23 10:23:54+02', '2015-08-20 10:23:54+02', '2015-08-20 10:23:54+02', 'akillinen-hoitotyo'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_akillinen_tot_elokuu_paivanhinta'),
  ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'),
   (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null),
   '2015-08-24 10:23:54+02', '2015-08-20 10:23:54+02', '2015-08-20 10:23:54+02', 'vahinkojen-korjaukset'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'KAJlyv_vahinkojen-korjaukset_tot_elokuu_paivanhinta');

INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id, hoitokauden_alkuvuosi)
VALUES
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot1'), '2015-01-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Is 2-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot1'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot2'), '2015-01-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot2'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Is 2-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot_heinakuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu_eka'), '2015-08-02 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu_eka'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu2'), '2015-08-20 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu2'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Is 1-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_heinakuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_heinakuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_elokuu_eka'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Is 1-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_elokuu_eka'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_lisatyo_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_lisatyo_tot_elokuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_akillinen_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_akillinen_tot_heinakuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_akillinen_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_akillinen_tot_elokuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_vahinkojen-korjaukset_tot_elokuu_paivanhinta'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE   nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_vahinkojen-korjaukset_tot_elokuu_paivanhinta'), 2014);

INSERT INTO toteuma_tehtava (toteuma, toimenpidekoodi, maara, paivan_hinta, indeksi, urakka_id, hoitokauden_alkuvuosi)
VALUES
  ((SELECT id FROM toteuma WHERE lisatieto = 'KAJlyv_muutostyo_tot_heinakuu_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Metsän harvennus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAJlyv_muutostyo_tot_heinakuu_paivanhinta'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'KAJlyv_muutostyo_tot_heinakuu_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAJlyv_muutostyo_tot_heinakuu_paivanhinta'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'KAJlyv_muutostyo_tot_elokuu_eka_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Metsän harvennus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAJlyv_muutostyo_tot_elokuu_eka_paivanhinta'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'KAJlyv_muutostyo_tot_elokuu_eka_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAJlyv_muutostyo_tot_elokuu_eka_paivanhinta'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_1'), (SELECT id FROM tehtava WHERE nimi = 'Metsän harvennus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_1'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_1'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_1'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_2'), (SELECT id FROM tehtava WHERE nimi = 'Metsän harvennus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_2'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_2'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAJlyv_lisatyo_tot_elokuu_paivanhinta_2'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'KAJlyv_akillinen_tot_elokuu_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAJlyv_akillinen_tot_elokuu_paivanhinta'), 2014);
...
VALUES
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), '2015-05-15', '2015-05-15', -1000, 'MAKU 2010', 'Urakoitsija maksaa tilaajalle', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), '2015-06-15', '2015-06-15', 1000, 'MAKU 2010', 'Vahingot on nyt korjattu, lasku tulossa.', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), '2015-07-15', '2015-07-15', 1000, null, 'Tilaaja maksaa urakoitsijlle.', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), '2015-08-01', '2015-08-01', 1000, 'MAKU 2010', 'Muu erilliskustannus', '2015-08-01', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('asiakastyytyvaisyysbonus', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), '2015-08-15', '2015-08-15', 1000, 'MAKU 2005', 'Asiakkaat erittäin tyytyväisiä, tyytyväisyysindeksi 0,92.', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Kajaani Talvihoito TP 2014-2019'), '2015-09-15', '2015-09-15', 1000, 'MAKU 2010', 'Muun erilliskustannuksen lisätieto', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh'));
...
INSERT INTO suolasakko (maara, hoitokauden_alkuvuosi, maksukuukausi, indeksi, urakka, talvisuolaraja)
     VALUES (30.0, 2014, 8, 'MAKU 2005', (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), 800);
...
-- Sanktioita
INSERT INTO sanktio (sakkoryhma, maara, perintapvm, maarattypvm,  indeksi, laatupoikkeama, toimenpideinstanssi, tyyppi, suorasanktio, luoja)
VALUES ('A'::sanktiolaji, 100, '2015-01-12 06:06.37', '2015-01-12 06:06.37', 'MAKU 2010', null, (SELECT id FROM toimenpideinstanssi WHERE nimi = 'Kajaani Talvihoito TP 2014-2019'),
        (SELECT id
           FROM sanktiotyyppi
                -- 1, Muu tuote
          WHERE koodi = 1), true, 2),
  ('A'::sanktiolaji, 500, '2015-05-12 06:06.37', '2015-05-12 06:06.37', 'MAKU 2010', null, (SELECT id FROM toimenpideinstanssi WHERE nimi = 'Kajaani Liikenneympäristön hoito TP 2014-2019'),
   (SELECT id
           FROM sanktiotyyppi
                -- 1, Muu tuote
          WHERE koodi = 1), true, 2),
  ('A'::sanktiolaji, 700, '2015-07-12 06:06.37', '2015-07-12 06:06.37', null, null, (SELECT id FROM toimenpideinstanssi WHERE nimi = 'Kajaani Liikenneympäristön hoito TP 2014-2019'),
   (SELECT id
           FROM sanktiotyyppi
                -- 1, Muu tuote
          WHERE koodi = 1), true, 2),
  ('A'::sanktiolaji, 1000, '2015-08-01 00:00.00', '2015-08-01 00:00.00', 'MAKU 2010', null, (SELECT id FROM toimenpideinstanssi WHERE nimi = 'Kajaani Sorateiden hoito TP 2014-2019'),
   (SELECT id
           FROM sanktiotyyppi
                -- 1, Muu tuote
          WHERE koodi = 1), true, 2),
  ('A'::sanktiolaji, 800, '2015-08-12 06:06.37', '2015-08-12 06:06.37', 'MAKU 2010', null, (SELECT id FROM toimenpideinstanssi WHERE nimi = 'Kajaani Sorateiden hoito TP 2014-2019'),
   (SELECT id
           FROM sanktiotyyppi
                -- 1, Muu tuote
          WHERE koodi = 1), true, 2),
  ('A'::sanktiolaji, 900, '2015-09-12 06:06.37', '2015-09-12 06:06.37', 'MAKU 2010', null, (SELECT id FROM toimenpideinstanssi WHERE nimi = 'Kajaani Sorateiden hoito TP 2014-2019'),
   (SELECT id
           FROM sanktiotyyppi
                -- 1, Muu tuote
          WHERE koodi = 1), true, 2),
  ('A'::sanktiolaji, 20160, '2016-09-12 06:06.37', '2016-09-12 06:06.37', 'MAKU 2010', null, (SELECT id FROM toimenpideinstanssi WHERE nimi = 'Kajaani Sorateiden hoito TP 2014-2019'),
   (SELECT id
           FROM sanktiotyyppi
                -- 1, Muu tuote
          WHERE koodi = 1), true, 2);
