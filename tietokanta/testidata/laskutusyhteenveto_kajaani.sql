...
INSERT INTO yksikkohintainen_tyo (alkupvm, loppupvm, maara, yksikko, yksikkohinta, tehtava, urakka, sopimus)
    VALUES ('2014-10-01', '2014-12-31', 3, 'km', 100, (SELECT id FROM tehtava WHERE taso=4 AND nimi='Is 2-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
           ('2015-01-01', '2015-09-30', 9, 'km', 100, (SELECT id FROM tehtava WHERE taso=4 AND nimi='Is 2-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
           ('2014-10-01', '2014-12-31', 60, 'ha', 100, (SELECT id FROM tehtava WHERE taso=4 AND nimi='Metsän harvennus'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
           ('2015-01-01', '2015-09-30', 180, 'ha', 100, (SELECT id FROM tehtava WHERE taso=4 AND nimi='Metsän harvennus'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null));
...
VALUES ((SELECT alkupvm FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT loppupvm FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), 'tiekm', 100.0, (SELECT id FROM tehtava WHERE taso=4 AND nimi='Is 1-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null)),
       ((SELECT alkupvm FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (SELECT loppupvm FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), 'ha', 100.0, (SELECT id FROM tehtava WHERE taso=4 AND nimi='Vesakonraivaus'), (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Kajaanin alueurakka 2014-2019') AND paasopimus IS null));
...
VALUES
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot1'), '2015-01-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Is 2-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot1')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot2'), '2015-01-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot2')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Is 2-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot_heinakuu')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu_eka'), '2015-08-02 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu_eka')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu2'), '2015-08-20 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_yht_tot_elokuu2')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Is 1-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_heinakuu')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_heinakuu')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_elokuu_eka'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Is 1-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_muutostyo_tot_elokuu_eka')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_lisatyo_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_lisatyo_tot_elokuu')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_akillinen_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_akillinen_tot_heinakuu')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_akillinen_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_akillinen_tot_elokuu')),
  ((SELECT id from toteuma where lisatieto = 'KAJlyv_vahinkojen-korjaukset_tot_elokuu_paivanhinta'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE taso=4 AND nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'KAJlyv_vahinkojen-korjaukset_tot_elokuu_paivanhinta'));
