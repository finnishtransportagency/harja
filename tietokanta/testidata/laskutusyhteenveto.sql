...
INSERT INTO yksikkohintainen_tyo (alkupvm, loppupvm, maara, yksikko, yksikkohinta, tehtava, urakka, sopimus)
    VALUES ('2014-10-01', '2014-12-31', 3, 'km', 100, (SELECT id FROM tehtava WHERE nimi='Is 2-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null)),
           ('2015-01-01', '2015-09-30', 9, 'km', 100, (SELECT id FROM tehtava WHERE nimi='Is 2-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null)),
           ('2014-10-01', '2014-12-31', 60, 'ha', 100, (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null)),
           ('2015-01-01', '2015-09-30', 180, 'ha', 100, (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null));
...
INSERT INTO toteuma_materiaali (toteuma, luotu, materiaalikoodi, maara, urakka_id, hoitokauden_alkuvuosi, luoja)
    VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'LYV-toteuma'), '2015-02-19 10:23:54+02',
            (SELECT id FROM materiaalikoodi WHERE nimi='Talvisuolaliuos NaCl'), 1800, (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), 2014, (SELECT id FROM kayttaja WHERE kayttajanimi = 'jvh'));
...
VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'LYV-toteuma Talvisuola'), '2015-02-19 10:23:54+02',
        (SELECT id FROM materiaalikoodi WHERE nimi='Talvisuola, rakeinen NaCl'), 200, (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (SELECT id FROM kayttaja WHERE kayttajanimi = 'jvh'), 2014);
...
VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'LYV-toteuma Natriumformiaatti'), '2015-02-19 10:23:54+02',
        (SELECT id FROM materiaalikoodi WHERE nimi='Natriumformiaatti'), 2000, (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (SELECT id FROM kayttaja WHERE kayttajanimi = 'jvh'), 2014);
...
VALUES
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Oulu Talvihoito TP 2014-2019'), '2015-05-15', '2015-05-15', -1000, 'MAKU 2010', 'Urakoitsija maksaa tilaajalle', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Oulu Talvihoito TP 2014-2019'), '2015-06-15', '2015-06-15', 1000, 'MAKU 2010', 'Vahingot on nyt korjattu, lasku tulossa.', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Oulu Talvihoito TP 2014-2019'), '2015-07-15', '2015-07-15', 1000, null, 'Tilaaja maksaa urakoitsijlle.', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Oulu Talvihoito TP 2014-2019'), '2015-08-01', '2015-08-15', 1000, 'MAKU 2010', 'Muu erilliskustannus', '2015-08-01', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('asiakastyytyvaisyysbonus', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Oulu Talvihoito TP 2014-2019'), '2015-08-15', '2015-08-15', 1000, 'MAKU 2005', 'Asiakkaat erittäin tyytyväisiä, tyytyväisyysindeksi 0,92.', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Oulun alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Oulu Talvihoito TP 2014-2019'), '2015-09-15', '2015-09-15', 1000, 'MAKU 2010', 'Muun erilliskustannuksen lisätieto', '2015-09-13', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh'));
...
INSERT INTO maksuera (toimenpideinstanssi, tyyppi, nimi) VALUES ((SELECT id from toimenpideinstanssi WHERE nimi = 'KOPIO POP MHU Suomussalmi 2024-2029 Talvihoito TP'), 'kokonaishintainen', 'KOPIO POP MHU Suomussalmi 2024-2029 Talvihoito' );
INSERT INTO maksuera (toimenpideinstanssi, tyyppi, nimi) VALUES ((SELECT id from toimenpideinstanssi WHERE nimi = 'KOPIO POP MHU Suomussalmi 2024-2029 Liikenneympäristön hoito TP'), 'kokonaishintainen', 'KOPIO POP MHU Suomussalmi 2024-2029 Liikenneympäristön hoito' );
INSERT INTO maksuera (toimenpideinstanssi, tyyppi, nimi) VALUES ((SELECT id from toimenpideinstanssi WHERE nimi = 'KOPIO POP MHU Suomussalmi 2024-2029 Soratien hoito TP'), 'kokonaishintainen', 'KOPIO POP MHU Suomussalmi 2024-2029 Soratien hoito' );
INSERT INTO maksuera (toimenpideinstanssi, tyyppi, nimi) VALUES ((SELECT id from toimenpideinstanssi WHERE nimi = 'KOPIO POP MHU Suomussalmi 2024-2029 MHU ja HJU Hoidon johto'), 'kokonaishintainen', 'KOPIO POP MHU Suomussalmi 2024-2029 MHU ja HJU Hoidon johto' );
INSERT INTO maksuera (toimenpideinstanssi, tyyppi, nimi) VALUES ((SELECT id from toimenpideinstanssi WHERE nimi = 'KOPIO POP MHU Suomussalmi 2024-2029 Päällystepaikkaukset TP'), 'kokonaishintainen', 'KOPIO POP MHU Suomussalmi 2024-2029 Päällystepaikkaukset' );
INSERT INTO maksuera (toimenpideinstanssi, tyyppi, nimi) VALUES ((SELECT id from toimenpideinstanssi WHERE nimi = 'KOPIO POP MHU Suomussalmi 2024-2029 MHU Ylläpito TP'), 'kokonaishintainen', 'KOPIO POP MHU Suomussalmi 2024-2029 MHU Ylläpito' );
INSERT INTO maksuera (toimenpideinstanssi, tyyppi, nimi) VALUES ((SELECT id from toimenpideinstanssi WHERE nimi = 'KOPIO POP MHU Suomussalmi 2024-2029 MHU Korvausinvestointi TP'), 'kokonaishintainen', 'KOPIO POP MHU Suomussalmi 2024-2029 MHU Korvausinvestointi' );
