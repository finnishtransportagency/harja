...
insert into paikkauskohde (nimi, luotu, "urakka-id", alkupvm, loppupvm, "paikkauskohteen-tila", "ulkoinen-id",
                           tyomenetelma, tyomenetelma_kuvaus, tierekisteriosoite, "suunniteltu-maara", "suunniteltu-hinta", yksikko) VALUES
('Kaislajärven suora', current_timestamp, (SELECT id FROM urakka WHERE nimi = 'Kemin päällystysurakka'),
 ...
 ROW (926, 5, 2764, 6, 2964, NULL) :: TR_OSOITE, 100, 100, 't');

insert into paikkauskohde (nimi, luotu, "urakka-id", alkupvm, loppupvm, "paikkauskohteen-tila", "ulkoinen-id",
                           tyomenetelma, tyomenetelma_kuvaus, tierekisteriosoite, tilattupvm, "suunniteltu-maara", "suunniteltu-hinta", yksikko) VALUES
('Kaislajärven suora osa 1', current_timestamp, (SELECT id FROM urakka WHERE nimi = 'Kemin päällystysurakka'),
 ...
 ROW (926, 6, 2964, 7, 3064, NULL) :: TR_OSOITE, '2021-02-17', 200, 200, 'm2');
...
('Kaislajärven suora osa 2', current_timestamp, (SELECT id FROM urakka WHERE nimi = 'Kemin päällystysurakka'),
 ...
 ROW (926, 7, 3164, 8, 3264, NULL) :: TR_OSOITE, 300, 300, 'kpl');

insert into paikkauskohde (nimi, luotu, "urakka-id", alkupvm, loppupvm, "paikkauskohteen-tila", "ulkoinen-id",
                           tyomenetelma, tyomenetelma_kuvaus, tierekisteriosoite, "suunniteltu-maara", "suunniteltu-hinta", yksikko, lisatiedot) VALUES
('Kaislajärven suora osa 3', current_timestamp, (SELECT id FROM urakka WHERE nimi = 'Kemin päällystysurakka'),
 ...
 ROW (926, 9, 3364, 12, 3964, NULL) :: TR_OSOITE,  400, 400, 'jm', 'Keskustelujen jälkeen päädyttiin siihen, että tätä kohtaa ei tarvitse paikata.');
...
(0000, 'Muokattava testikohde', current_timestamp, 36, '2021-01-01', '2021-01-02', 'Urapaikkaus (UREM/RREM)', ROW(926, 9, 3364, 12, 3964, NULL) :: TR_OSOITE, 'ehdotettu',
