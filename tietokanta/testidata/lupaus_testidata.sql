DO $$
    ...
    BEGIN
        ...
        INSERT INTO urakka_tavoite(urakka, hoitokausi, tarjous_tavoitehinta, tavoitehinta, kattohinta, tavoitehinta_indeksikorjattu, kattohinta_indeksikorjattu, luotu)
        VALUES (urakkaid, 5, 90000, 144000, 134640, testidata_indeksikorjaa(100000, (4 + alkuvuosi), 10, urakkaid), testidata_indeksikorjaa(110000, (4 + alkuvuosi), 10, urakkaid), NOW());
    END
$$ LANGUAGE plpgsql;
