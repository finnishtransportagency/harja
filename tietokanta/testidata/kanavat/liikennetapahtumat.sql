...
VALUES
  ((SELECT id FROM kan_kohde WHERE nimi = 'Tikkalansaaren sulku'),NOW() - INTERVAL '1 minutes', 'sulutus', 'kauko', 1, 'Testidata 1', 7000, 8000, (SELECT id FROM kayttaja WHERE kayttajanimi='tero'), (SELECT id FROM kayttaja WHERE kayttajanimi='tero'), false),
  ...
  ((SELECT id FROM kan_kohde WHERE nimi = 'Tikkalansaaren sulku'),NOW() - INTERVAL '2 minutes', 'tyhjennys', 'paikallis', 1, 'Testidata 3', 7000, 8000, (SELECT id FROM kayttaja WHERE kayttajanimi='tero'), (SELECT id FROM kayttaja WHERE kayttajanimi='tero'), false),
  ((SELECT id FROM kan_kohde WHERE nimi = 'Tikkalansaaren sulku'),NOW() - INTERVAL '3 minutes', 'tyhjennys', 'kauko', 1, 'Testidata 4', 7000, 8000, (SELECT id FROM kayttaja WHERE kayttajanimi='tero'), (SELECT id FROM kayttaja WHERE kayttajanimi='tero'), TRUE),
  ((SELECT id FROM kan_kohde WHERE nimi = 'Tikkalansaaren sulku'),NOW() - INTERVAL '5 minutes', 'sulutus', 'itse', 15, 'Testidata 5', 7000, 8000, (SELECT id FROM kayttaja WHERE kayttajanimi='tero'), (SELECT id FROM kayttaja WHERE kayttajanimi='tero'), false);
