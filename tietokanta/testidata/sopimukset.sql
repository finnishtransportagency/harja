...
INSERT INTO sopimus (nimi, alkupvm, loppupvm, sampoid, urakka) VALUES ('Muhoksen päällystyksen pääsopimus', '2017-01-01','2024-12-31','5H05228/10', (SELECT id FROM urakka WHERE nimi='Muhoksen päällystysurakka'));
INSERT INTO sopimus (nimi, alkupvm, loppupvm, sampoid, urakka) VALUES ('Aktiivinen Oulu päällystyksen pääsopimus', '2025-09-25','2029-09-25','1113-TES', (SELECT id FROM urakka WHERE nimi='Aktiivinen Oulu Päällystys Testi'));
...
--Kuvitteellinen MHU Kittilä sopimus
INSERT INTO sopimus (nimi, alkupvm, loppupvm, sampoid, urakka)
VALUES ('Kittilän MHU sopimus', '2019-10-01', '2023-09-30', '11333377-LAP1',
        (SELECT id FROM urakka WHERE nimi = 'Kittilän MHU 2019-2024'));
INSERT INTO sopimus (nimi, alkupvm, loppupvm, sampoid, urakka)
VALUES ('Kittilän MHU sopimus 25', '2025-10-01', '2030-09-30', '11333378-LAP1',
        (SELECT id FROM urakka WHERE nimi = 'Kittilän MHU 2025-2030'));
-- Raaseporin sopimus
INSERT INTO sopimus (nimi, alkupvm, loppupvm, sampoid, urakka)
VALUES
