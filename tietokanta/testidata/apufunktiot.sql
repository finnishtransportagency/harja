...
begin
	...
	for tpk_rivi in select tpk.id from toimenpidekoodi tpk join tehtavaryhma tr on tr.id = tpk.tehtavaryhma and tpk.yksikko is not null and tpk.poistettu is not null loop 
	raise notice 'tiedot tpk id :: %', tpk_rivi.id;
