...
INSERT INTO yksikkohintainen_tyo (alkupvm, loppupvm, maara, yksikko, yksikkohinta, tehtava, urakka, sopimus)
    VALUES ('2014-10-01', '2014-12-31', 3, 'km', 100, (SELECT id FROM tehtava WHERE nimi='Is 2-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019') AND paasopimus IS null)),
           ('2015-01-01', '2015-09-30', 9, 'km', 100, (SELECT id FROM tehtava WHERE nimi='Is 2-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019') AND paasopimus IS null)),
           ('2014-10-01', '2014-12-31', 60, 'ha', 100, (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019') AND paasopimus IS null)),
           ('2015-01-01', '2015-09-30', 180, 'ha', 100, (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019') AND paasopimus IS null));
...
VALUES ((SELECT alkupvm FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (SELECT loppupvm FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), 'tiekm', 100.0, (SELECT id FROM tehtava WHERE nimi='Is 1-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019') AND paasopimus IS null)),
       ((SELECT alkupvm FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (SELECT loppupvm FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), 'ha', 100.0, (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus/ha'), (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019') AND paasopimus IS null));
...
INSERT INTO toteuma_materiaali (toteuma, luotu, materiaalikoodi, maara, urakka_id, hoitokauden_alkuvuosi)
    VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'ESP-LYV-toteuma'), '2015-02-19 10:23:54+02',
            (SELECT id FROM materiaalikoodi WHERE nimi='Talvisuolaliuos NaCl'), 2000, (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), 2014);
...
VALUES
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_yht_tot1'), '2015-01-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Is 2-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_yht_tot1'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_yht_tot2'), '2015-01-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_yht_tot2'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_yht_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Is 2-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_yht_tot_heinakuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_yht_tot_elokuu_eka'), '2015-08-02 00:00.00', (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_yht_tot_elokuu_eka'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_yht_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_yht_tot_elokuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_yht_tot_elokuu2'), '2015-08-20 00:00.00', (SELECT id FROM tehtava WHERE nimi='Metsän harvennus'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_yht_tot_elokuu2'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_muutostyo_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Is 1-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_muutostyo_tot_heinakuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_muutostyo_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_muutostyo_tot_heinakuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_muutostyo_tot_elokuu_eka'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Is 1-ajorat. KVL >15000'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_muutostyo_tot_elokuu_eka'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_lisatyo_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_lisatyo_tot_elokuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_akillinen_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_akillinen_tot_heinakuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_akillinen_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_akillinen_tot_elokuu'), 2014),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_vahinkojen-korjaukset_tot_elokuu_paivanhinta'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus/ha'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_vahinkojen-korjaukset_tot_elokuu_paivanhinta'), 2014);

INSERT INTO toteuma_tehtava (toteuma, toimenpidekoodi, maara, paivan_hinta, indeksi, urakka_id, hoitokauden_alkuvuosi)
VALUES
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_heinakuu_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Metsän harvennus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_heinakuu_paivanhinta'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_heinakuu_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_heinakuu_paivanhinta'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_elokuu_eka_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Metsän harvennus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_elokuu_eka_paivanhinta'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_elokuu_eka_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_elokuu_eka_paivanhinta'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_1'), (SELECT id FROM tehtava WHERE nimi = 'Metsän harvennus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_1'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_1'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_1'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_2'), (SELECT id FROM tehtava WHERE nimi = 'Metsän harvennus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_2'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_2'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_2'), 2014),
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_akillinen_tot_elokuu_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus/ha'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_akillinen_tot_elokuu_paivanhinta'), 2014);
...
VALUES
  ...
  ('muu', (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019') AND paasopimus IS null), (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (SELECT id FROM toimenpideinstanssi WHERE nimi='Espoo Talvihoito TP 2014-2019'), '2015-08-01',  '2015-08-15', 1000, 'MAKU 2010', 'Muu erilliskustannus', '2015-08-01', (SELECT ID FROM kayttaja WHERE kayttajanimi = 'yit_uuvh')),
...
VALUES ('A'::SANKTIOLAJI, 100, '2015-01-12 06:06.37', '2015-01-12 06:06.37', 'MAKU 2010', NULL,
       ...
       ('A'::SANKTIOLAJI, 500, '2015-05-12 06:06.37', '2015-05-12 06:06.37', 'MAKU 2010', NULL,
        (SELECT id FROM toimenpideinstanssi WHERE nimi = 'Espoo Liikenneympäristön hoito TP 2014-2019'),
        (SELECT id
           FROM sanktiotyyppi
                -- 1, Muu tuote
          WHERE koodi = 1), TRUE, 2),
       ...
       ('A'::SANKTIOLAJI, 1000, '2015-08-01 00:00.00', '2015-08-01 00:00.00', 'MAKU 2010', NULL,
        (SELECT id FROM toimenpideinstanssi WHERE nimi = 'Espoo Sorateiden hoito TP 2014-2019'),
        (SELECT id
           FROM sanktiotyyppi
                -- 1, Muu tuote
          WHERE koodi = 1), TRUE, 2),
