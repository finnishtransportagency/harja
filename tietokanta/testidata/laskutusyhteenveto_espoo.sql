...
VALUES ((SELECT alkupvm FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (SELECT loppupvm FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), 'tiekm', 100.0, (SELECT id FROM tehtava WHERE nimi='Is 1-ajorat. KVL >15000'), (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019') AND paasopimus IS null)),
       ((SELECT alkupvm FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (SELECT loppupvm FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), 'ha', 100.0, (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus'), (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019'), (select id from sopimus where urakka = (SELECT id FROM urakka WHERE nimi='Espoon alueurakka 2014-2019') AND paasopimus IS null));
...
VALUES
  ...
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_muutostyo_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_muutostyo_tot_heinakuu')),
  ...
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_lisatyo_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_lisatyo_tot_elokuu')),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_akillinen_tot_heinakuu'), '2015-07-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_akillinen_tot_heinakuu')),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_akillinen_tot_elokuu'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_akillinen_tot_elokuu')),
  ((SELECT id from toteuma where lisatieto = 'ESPlyv_vahinkojen-korjaukset_tot_elokuu_paivanhinta'), '2015-08-19 00:00.00', (SELECT id FROM tehtava WHERE nimi='Vesakonraivaus'), 10, (SELECT urakka from toteuma where lisatieto = 'ESPlyv_vahinkojen-korjaukset_tot_elokuu_paivanhinta'));
...
VALUES
  ...
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_heinakuu_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_heinakuu_paivanhinta')),
  ...
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_elokuu_eka_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_muutostyo_tot_elokuu_eka_paivanhinta')),
  ...
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_1'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_1')),
  ...
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_2'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_lisatyo_tot_elokuu_paivanhinta_2')),
  ((SELECT id FROM toteuma WHERE lisatieto = 'ESPlyv_akillinen_tot_elokuu_paivanhinta'), (SELECT id FROM tehtava WHERE nimi = 'Vesakonraivaus'), 10, 1000, false, (SELECT urakka FROM toteuma WHERE lisatieto = 'ESPlyv_akillinen_tot_elokuu_paivanhinta'));
