...
BEGIN
  ...
  FOREACH toimenpidenimi IN ARRAY toimenpidenimet LOOP
    ...
    FOR i IN 10..12 LOOP
        ...
        VALUES (urakan_alkuvuosi, i, 8000 + i*100, testidata_indeksikorjaa(8000 + i*800, urakan_alkuvuosi, urakka_id),(select id from toimenpideinstanssi where nimi = toimenpideinstanssin_nimi ), null);
    END LOOP;
    FOR i IN 1..12 LOOP
      FOR vuosi_ IN 1..4 LOOP
        INSERT INTO kiinteahintainen_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, toimenpideinstanssi, sopimus)
          VALUES (vuosi_ + urakan_alkuvuosi, i, 8000 + i*100, testidata_indeksikorjaa(8000 + i*100, vuosi_ + urakan_alkuvuosi, urakka_id), (select id from toimenpideinstanssi where nimi = toimenpideinstanssin_nimi ), null);
      END LOOP;
    END LOOP;
    FOR i IN 1..9 LOOP
      INSERT INTO kiinteahintainen_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, toimenpideinstanssi, sopimus)
        VALUES (5 + urakan_alkuvuosi, i, 8000 + i*100, testidata_indeksikorjaa(8000 + i*100, 5 + urakan_alkuvuosi, urakka_id),(select id from toimenpideinstanssi where nimi = toimenpideinstanssin_nimi ), null);
    END LOOP;
  END LOOP;
      ...
      INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
        VALUES -- kolmansien osapuolien aiheuttamat vahingot
               (urakan_alkuvuosi, i, 5000,
                testidata_indeksikorjaa(5000, urakan_alkuvuosi, urakka_id),
                ...
                (urakan_alkuvuosi, i, 20000,
                 testidata_indeksikorjaa(20000, urakan_alkuvuosi, urakka_id),
      ...
      IF toimenpidenimi = 'Liikenneympäristön hoito TP' THEN
        INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
          VALUES (urakan_alkuvuosi, i, 1000,
                  testidata_indeksikorjaa(1000, urakan_alkuvuosi, urakka_id),
        ...
        INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
          VALUES -- kolmansien osapuolien aiheuttamat vahingot
                 ((vuosi_ + urakan_alkuvuosi), i, 100,
                  testidata_indeksikorjaa(100, (vuosi_ + urakan_alkuvuosi), urakka_id),
                  'vahinkojen-korjaukset'::TOTEUMATYYPPI,
                  (SELECT id
                   FROM toimenpidekoodi
                   WHERE yksiloiva_tunniste= CASE
                ...
                ((vuosi_ + urakan_alkuvuosi), i, 20000,
                 testidata_indeksikorjaa(20000, (vuosi_ + urakan_alkuvuosi), urakka_id),
                 'akillinen-hoitotyo'::TOTEUMATYYPPI,
                 (SELECT id
                  FROM toimenpidekoodi
                  WHERE yksiloiva_tunniste = CASE
        ...
        IF toimenpidenimi = 'Liikenneympäristön hoito TP' THEN
          INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
            VALUES ((vuosi_ + urakan_alkuvuosi), i, 1000,
                    testidata_indeksikorjaa(1000, (vuosi_ + urakan_alkuvuosi), urakka_id),
                    'laskutettava-tyo'::TOTEUMATYYPPI, NULL, NULL, (select id from toimenpideinstanssi where nimi = toimenpideinstanssin_nimi),
                urakan_sopimus);
        END IF;
      END LOOP;
      ...
      INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
        VALUES -- kolmansien osapuolien aiheuttamat vahingot
               ((5 + urakan_alkuvuosi), i, 100,
                testidata_indeksikorjaa(100, (5 + urakan_alkuvuosi), urakka_id),
                'vahinkojen-korjaukset'::TOTEUMATYYPPI,
                (SELECT id
                 FROM toimenpidekoodi
                 WHERE yksiloiva_tunniste = CASE
                ...
                ((5 + urakan_alkuvuosi), i, 20000,
                 testidata_indeksikorjaa(20000, (5 + urakan_alkuvuosi), urakka_id),
                'akillinen-hoitotyo'::TOTEUMATYYPPI,
                (SELECT id
                 FROM toimenpidekoodi
                 WHERE yksiloiva_tunniste= CASE
      ...
      IF toimenpidenimi = 'Liikenneympäristön hoito TP' THEN
        INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
          VALUES ((5 + urakan_alkuvuosi), i, 1000,
                  testidata_indeksikorjaa(1000, (5 + urakan_alkuvuosi), urakka_id),
                  'laskutettava-tyo'::TOTEUMATYYPPI, NULL, NULL, (select id from toimenpideinstanssi where nimi = toimenpideinstanssin_nimi),
                urakan_sopimus);
      END IF;
    END LOOP;
    ...
    INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
      VALUES -- Erillishankinnat
                (urakan_alkuvuosi, i, 700,
                 testidata_indeksikorjaa(700, urakan_alkuvuosi, urakka_id),
                ...
                (urakan_alkuvuosi, i, 9000,
                 testidata_indeksikorjaa(9000, urakan_alkuvuosi, urakka_id),
                'laskutettava-tyo'::TOTEUMATYYPPI,
                ...
                (urakan_alkuvuosi, i, 9100,
                 testidata_indeksikorjaa(9100, urakan_alkuvuosi, urakka_id),
                'laskutettava-tyo'::TOTEUMATYYPPI,
      ...
      INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
        VALUES -- Erillishankinnat
                ((vuosi_ + urakan_alkuvuosi), i, 700,
                 testidata_indeksikorjaa(700, (vuosi_ + urakan_alkuvuosi), urakka_id),
                'laskutettava-tyo'::TOTEUMATYYPPI,
                NULL,
                (SELECT id FROM tehtavaryhma WHERE yksiloiva_tunniste='37d3752c-9951-47ad-a463-c1704cf22f4c'::UUID),
                (select id from toimenpideinstanssi where nimi = toimenpideinstanssin_nimi),
                ...
                ((vuosi_ + urakan_alkuvuosi), i, 9000,
                 testidata_indeksikorjaa(9000, (vuosi_ + urakan_alkuvuosi), urakka_id),
                'laskutettava-tyo'::TOTEUMATYYPPI,
                (SELECT id FROM toimenpidekoodi WHERE yksiloiva_tunniste = '8376d9c4-3daf-4815-973d-cd95ca3bb388'::UUID),
                NULL,
                (SELECT id FROM toimenpideinstanssi WHERE nimi = toimenpideinstanssin_nimi),
                ...
                ((vuosi_ + urakan_alkuvuosi), i, 9100,
                 testidata_indeksikorjaa(9100, (vuosi_ + urakan_alkuvuosi), urakka_id),
                'laskutettava-tyo'::TOTEUMATYYPPI,
                (SELECT id FROM toimenpidekoodi WHERE yksiloiva_tunniste = '53647ad8-0632-4dd3-8302-8dfae09908c8'::UUID),
                NULL,
                (SELECT id FROM toimenpideinstanssi WHERE nimi = toimenpideinstanssin_nimi),
    ...
    INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
      VALUES -- Erillishankinnat
                ((5 + urakan_alkuvuosi), i, 700,
                 testidata_indeksikorjaa(700, (5 + urakan_alkuvuosi), urakka_id),
                'laskutettava-tyo'::TOTEUMATYYPPI,
                NULL,
                (SELECT id FROM tehtavaryhma WHERE yksiloiva_tunniste='37d3752c-9951-47ad-a463-c1704cf22f4c'::UUID),
                (select id from toimenpideinstanssi where nimi = toimenpideinstanssin_nimi),
                ...
                ((5 + urakan_alkuvuosi), i, 9000,
                 testidata_indeksikorjaa(9000, (5 + urakan_alkuvuosi), urakka_id),
                'laskutettava-tyo'::TOTEUMATYYPPI,
                (SELECT id FROM toimenpidekoodi WHERE yksiloiva_tunniste = '8376d9c4-3daf-4815-973d-cd95ca3bb388'::UUID),
                NULL,
                (SELECT id FROM toimenpideinstanssi WHERE nimi = toimenpideinstanssin_nimi),
                ...
                ((5 + urakan_alkuvuosi), i, 9100,
                 testidata_indeksikorjaa(9100, (5 + urakan_alkuvuosi), urakka_id),
                'laskutettava-tyo'::TOTEUMATYYPPI,
                (SELECT id FROM toimenpidekoodi WHERE yksiloiva_tunniste = '53647ad8-0632-4dd3-8302-8dfae09908c8'::UUID),
                NULL,
                (SELECT id FROM toimenpideinstanssi WHERE nimi = toimenpideinstanssin_nimi),
...
BEGIN
  ...
  FOREACH toimenpidenimi IN ARRAY toimenpidenimet LOOP
    ...
    FOR i IN 10..12 LOOP
      INSERT INTO kiinteahintainen_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, toimenpideinstanssi, sopimus)
        VALUES (urakan_alkuvuosi, i, 8000 + i*100, testidata_indeksikorjaa(8000 + i*100, urakan_alkuvuosi, urakka_id)
, (select id from toimenpideinstanssi where nimi = toimenpideinstanssin_nimi ), null);
    ...
    FOR vuosi_ IN 1..4 LOOP
      INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
        VALUES ((vuosi_ + urakan_alkuvuosi), i, 5000,
              testidata_indeksikorjaa(5000, urakan_alkuvuosi, (vuosi_ + urakan_alkuvuosi)),
              'muut-rahavaraukset'::TOTEUMATYYPPI,
              NULL,
              (SELECT id
               FROM tehtavaryhma
  ...
  FOR i IN 1..9 LOOP
    INSERT INTO kustannusarvioitu_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, tyyppi, tehtava, tehtavaryhma, toimenpideinstanssi, sopimus)
      VALUES ((5 + urakan_alkuvuosi), i, 5000,
              testidata_indeksikorjaa(5000, urakan_alkuvuosi, (5 + urakan_alkuvuosi)),
              'muut-rahavaraukset'::TOTEUMATYYPPI,
              NULL,
              (SELECT id
               FROM tehtavaryhma
  ...
  LOOP
    ...
    INSERT INTO johto_ja_hallintokorvaus ("urakka-id", tunnit, tuntipalkka, tuntipalkka_indeksikorjattu, vuosi, kuukausi, "ennen-urakkaa", luotu, "toimenkuva-id")
      VALUES ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 4500, 40, testidata_indeksikorjaa(40, (SELECT extract(year from NOW())), urakka_id), (SELECT extract(year from NOW())), 10, TRUE, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'hankintavastaava'));
  END LOOP;
  INSERT INTO johto_ja_hallintokorvaus ("urakka-id", tunnit, tuntipalkka, tuntipalkka_indeksikorjattu, vuosi, kuukausi, "ennen-urakkaa", luotu, "toimenkuva-id", "osa-kuukaudesta")
    VALUES ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 2250, 40, testidata_indeksikorjaa(40, (SELECT extract(year FROM NOW())), urakka_id),(SELECT extract(year from NOW())), 10, TRUE, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'hankintavastaava'), 0.5);
  FOR i IN 10..12 LOOP
    INSERT INTO johto_ja_hallintokorvaus ("urakka-id", tunnit, tuntipalkka, tuntipalkka_indeksikorjattu, vuosi, kuukausi, luotu, "toimenkuva-id")
      VALUES ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, urakan_alkuvuosi, urakka_id), urakan_alkuvuosi, i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'sopimusvastaava')),
             ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, urakan_alkuvuosi, urakka_id), urakan_alkuvuosi, i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'vastuunalainen työnjohtaja')),
             ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, urakan_alkuvuosi, urakka_id), urakan_alkuvuosi, i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'päätoiminen apulainen')),
             ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, urakan_alkuvuosi, urakka_id), urakan_alkuvuosi, i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'apulainen/työnjohtaja')),
             ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, urakan_alkuvuosi, urakka_id), urakan_alkuvuosi, i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'hankintavastaava'));
  END LOOP;
  FOR i IN 1..12 LOOP
    FOR vuosi_ IN 1..4 LOOP
      INSERT INTO johto_ja_hallintokorvaus ("urakka-id", tunnit, tuntipalkka, tuntipalkka_indeksikorjattu, vuosi, kuukausi, luotu, "toimenkuva-id")
        VALUES ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (vuosi_ + urakan_alkuvuosi), urakka_id), (SELECT vuosi_ + extract(year from (SELECT alkupvm FROM urakka WHERE nimi=urakan_nimi))), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'sopimusvastaava')),
               ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (vuosi_ + urakan_alkuvuosi), urakka_id), (SELECT vuosi_ + extract(year from (SELECT alkupvm FROM urakka WHERE nimi=urakan_nimi))), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'vastuunalainen työnjohtaja')),
               ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (vuosi_ + urakan_alkuvuosi), urakka_id), (SELECT vuosi_ + extract(year from (SELECT alkupvm FROM urakka WHERE nimi=urakan_nimi))), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'päätoiminen apulainen')),
               ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (vuosi_ + urakan_alkuvuosi), urakka_id), (SELECT vuosi_ + extract(year from (SELECT alkupvm FROM urakka WHERE nimi=urakan_nimi))), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'apulainen/työnjohtaja')),
               ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (vuosi_ + urakan_alkuvuosi), urakka_id), (SELECT vuosi_ + extract(year from (SELECT alkupvm FROM urakka WHERE nimi=urakan_nimi))), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'hankintavastaava'));

      IF (5 <= i) AND (i <= 8)
      THEN
        INSERT INTO johto_ja_hallintokorvaus ("urakka-id", tunnit, tuntipalkka, tuntipalkka_indeksikorjattu, vuosi, kuukausi, luotu, "toimenkuva-id")
        VALUES ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (vuosi_ + urakan_alkuvuosi), urakka_id), (SELECT vuosi_ + extract(year from (SELECT alkupvm FROM urakka WHERE nimi=urakan_nimi))), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'harjoittelija'));
      END IF;
      IF (4 <= i) AND (i <= 8)
      THEN
        INSERT INTO johto_ja_hallintokorvaus ("urakka-id", tunnit, tuntipalkka, tuntipalkka_indeksikorjattu, vuosi, kuukausi, luotu, "toimenkuva-id")
        VALUES ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (vuosi_ + urakan_alkuvuosi), urakka_id), vuosi_ + urakan_alkuvuosi, i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'viherhoidosta vastaava henkilö'));
      END IF;
    END LOOP;
  END LOOP;
  FOR i IN 1..9 LOOP
    ...
    END IF;
    INSERT INTO johto_ja_hallintokorvaus ("urakka-id", tunnit, tuntipalkka, tuntipalkka_indeksikorjattu, vuosi, kuukausi, luotu, "toimenkuva-id")
      VALUES ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (5 + urakan_alkuvuosi), urakka_id), (5 + urakan_alkuvuosi), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'sopimusvastaava')),
             ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (5 + urakan_alkuvuosi), urakka_id), (5 + urakan_alkuvuosi), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'vastuunalainen työnjohtaja')),
             ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (5 + urakan_alkuvuosi), urakka_id), (5 + urakan_alkuvuosi), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'päätoiminen apulainen')),
             ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (5 + urakan_alkuvuosi), urakka_id), (5 + urakan_alkuvuosi), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'apulainen/työnjohtaja')),
             ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (5 + urakan_alkuvuosi), urakka_id), (5 + urakan_alkuvuosi), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'hankintavastaava'));

      IF (5 <= i) AND (i <= 8)
      THEN
        INSERT INTO johto_ja_hallintokorvaus ("urakka-id", tunnit, tuntipalkka, tuntipalkka_indeksikorjattu, vuosi, kuukausi, luotu, "toimenkuva-id")
        VALUES ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (5 + urakan_alkuvuosi), urakka_id), (5 + urakan_alkuvuosi), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'harjoittelija'));
      END IF;
      IF (4 <= i) AND (i <= 8)
      THEN
        INSERT INTO johto_ja_hallintokorvaus ("urakka-id", tunnit, tuntipalkka, tuntipalkka_indeksikorjattu, vuosi, kuukausi, luotu, "toimenkuva-id")
        VALUES ((SELECT id FROM urakka WHERE nimi=urakan_nimi), 1000, 30, testidata_indeksikorjaa(30, (5 + urakan_alkuvuosi), urakka_id), (5 + urakan_alkuvuosi), i, NOW(), (SELECT id FROM johto_ja_hallintokorvaus_toimenkuva WHERE toimenkuva = 'viherhoidosta vastaava henkilö'));
      END IF;
  END LOOP;
END $$;
...
BEGIN
  ...
  FOREACH toimenpidenimi IN ARRAY toimenpidenimet LOOP
    ...
    FOR i IN 10..12 LOOP
      INSERT INTO kiinteahintainen_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, toimenpideinstanssi, sopimus)
      VALUES (urakan_alkuvuosi, i, 8000 + i*100, testidata_indeksikorjaa(8000 + i * 100, urakan_alkuvuosi, urakka_id), (select id from toimenpideinstanssi where nimi = toimenpideinstanssin_nimi ), null);
    END LOOP;
    FOR i IN 1..12 LOOP
      FOR vuosi_ IN 1..4 LOOP
       INSERT INTO kiinteahintainen_tyo (vuosi, kuukausi, summa, summa_indeksikorjattu, toimenpideinstanssi, sopimus)
...
BEGIN
  ...
  FOR i IN 1..6 LOOP
      ...
      END LOOP;
  INSERT INTO toimenpideinstanssi (urakka, toimenpide, nimi, alkupvm, loppupvm, tuotepolku, sampoid, talousosasto_id, talousosastopolku)
  VALUES ((SELECT id FROM urakka WHERE nimi=urakan2_nimi), (SELECT id FROM toimenpidekoodi WHERE koodi='23151'),
          urakan2_nimi || ' ' || 'MHU ja HJU Hoidon johto', (SELECT alkupvm FROM urakka WHERE nimi=urakan2_nimi),
          (SELECT loppupvm FROM urakka WHERE nimi=urakan2_nimi), 'tuotepolku', 'sampoid', 'talousosastoid', 'talousosastopolku');
END $$;
