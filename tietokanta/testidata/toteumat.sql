DO $$
    ...
    BEGIN
        ...
        urakka_id_kajaani_2014_2019 = (SELECT id FROM urakka where nimi = 'Kajaanin alueurakka 2014-20129');
        ...
        toimenpidekoodi_suolaus = (SELECT id FROM toimenpidekoodi WHERE nimi = 'Suolaus');
...
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, suorittajan_ytunnus, suorittajan_nimi, tyyppi, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_oulu_2014_2019, (SELECT id FROM sopimus WHERE nimi = 'Oulun alueurakka pääsopimus' AND urakka = urakka_id_oulu_2014_2019), '2015-12-17 08:22:45.049545', '2015-02-01 17:00:00.000000', '2015-02-01 18:05:00.000000', '8765432-1', 'Tehotekijät Oy', 'kokonaishintainen', 'Pitkä kokonaishintainen reitti');
