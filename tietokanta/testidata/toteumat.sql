DO $$
    DECLARE
        urakka_id_oulu_2005_2012 INTEGER;
        urakka_id_oulu_2014_2019 INTEGER;
        urakka_id_kajaani_2014_2019 INTEGER;

        sopimus_id_oulu_2005_2012 INTEGER;
        sopimus_id_oulu_2014_2019 INTEGER;
        sopimus_id_kajaani_2014_2019 INTEGER;

        toimenpidekoodi_suolaus INTEGER;
        materiaalikoodi_hiekoitushiekka INTEGER;

    BEGIN
        urakka_id_oulu_2005_2012 = (SELECT id FROM urakka where nimi = 'Oulun alueurakka 2005-2012');
        urakka_id_oulu_2014_2019 = (SELECT id FROM urakka where nimi = 'Oulun alueurakka 2014-2019');
        urakka_id_kajaani_2014_2019 = (SELECT id FROM urakka where nimi = 'Kajaanin alueurakka 2014-2019');

        sopimus_id_oulu_2005_2012 =  (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi = 'Oulun alueurakka 2005-2012' AND paasopimus IS NULL));
...
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, NOW(), '2005-10-01 00:00:00+02', '2005-10-02 00:00:00+02', 'yksikkohintainen'::toteumatyyppi, 'Seppo Suorittaja', '4153724-6', 'Reitillinen yksikköhintainen toteuma 2');
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, NOW(), '2005-10-01 00:00:00+02', '2005-10-02 00:00:00+02', 'yksikkohintainen'::toteumatyyppi, 'Antti Ahertaja', '1524792-1', 'Yksikköhintainen toteuma 1');
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, NOW(), '2005-10-02 00:00:00+02', '2005-10-03 00:00:00+02', 'yksikkohintainen'::toteumatyyppi, 'Teemu Työntekijä', '1524792-1', 'Yksikköhintainen toteuma 2');
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, NOW(), '2005-10-01 00:00:00+02', '2005-03-02 00:00:00+02', 'kokonaishintainen'::toteumatyyppi, 'Teppo Tienraivaaja', '4715514-4', 'Kokonaishintainen toteuma 1');
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, NOW(), '2005-10-03 00:00:00+02', '2005-10-04 00:00:00+02', 'kokonaishintainen'::toteumatyyppi, 'Ahti Ahkera', '4715514-4', 'Kokonaishintainen toteuma 2');
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, NOW(), '2005-10-10 00:09:00+02', '2005-10-11 00:00:00+02', 'kokonaishintainen'::toteumatyyppi, 'Eero Energia', '4715514-4', 'Kokonaishintainen toteuma 3');
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, NOW(), '2005-10-10 00:12:00+02', '2005-10-10 12:00:00+02', 'kokonaishintainen'::toteumatyyppi, 'Matti Matala', '4715514-4', 'Kokonaishintainen toteuma 4');
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto, luoja) VALUES ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, '2004-10-19 10:23:54+02', '2004-10-20 00:00:00+02', '2006-09-30 00:00:00+02', 'yksikkohintainen'::toteumatyyppi, 'Pekan Kone OY', '4715514-4', 'Automaattisesti lisätty fastroi toteuma', (SELECT id FROM kayttaja WHERE kayttajanimi = 'destia'));
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, suorittajan_ytunnus, suorittajan_nimi, tyyppi, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_oulu_2014_2019, sopimus_id_oulu_2014_2019, '2015-12-17 08:22:45.049545', '2015-02-01 17:00:00.000000', '2015-02-01 18:05:00.000000', '8765432-1', 'Tehotekijät Oy', 'kokonaishintainen', 'Pitkä kokonaishintainen reitti');
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, suorittajan_ytunnus, suorittajan_nimi, tyyppi, lisatieto) VALUES ('harja-ui'::lahde, urakka_id_kajaani_2014_2019, sopimus_id_kajaani_2014_2019, '2015-12-17 08:22:45.049545', '2015-02-01 17:00:00.000000', '2015-02-01 18:05:00.000000', '8765432-1', 'Tehotekijät Oy', 'kokonaishintainen', 'Pitkä kokonaishintainen reitti 2');
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 3 mm: Nuoli, lyhyt (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 5, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 3 mm: Nuoli, lyhyt (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 5, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 3 mm: Nuoli, lyhyt (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 5, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 3 mm: Nuoli, pitkä (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 5, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 3 mm: Nuoli, pitkä (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 5, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 3 mm: Nuoli, pitkä (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 5, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 7 mm: Nuoli, lyhyt (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 10, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 7 mm: Nuoli, lyhyt (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 10, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 7 mm: Nuoli, lyhyt (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 10, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 7 mm: Nuoli, pitkä (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 10, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 7 mm: Nuoli, pitkä (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 10, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 7 mm: Nuoli, pitkä (1-, 2- ja 3-kärkiset sekä ajokaistan päättymisnuoli)'), 10, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Täristävät merkinnät: sylinterijyrsintä, reunaviiva, 2 ajr tie: lev 30 cm, pit 13-15 cm, merkintäväli 60 cm, syvyys 15 mm'), 25000, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Täristävät merkinnät: sylinterijyrsintä, keskiviiva, 1 ajr tie: lev 30 cm, pit 13-15 cm, merkintäväli 60 cm, syvyys 15 mm'), 30000, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Täristävät merkinnät: sylinterijyrsintä, reunaviiva, 1 ajr tie: lev 30 cm, pit 13-15 cm, merkintäväli 60 cm, syvyys 15 mm'), 5000, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Linjamerkinnän upotusjyrsintä'), 500, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 3 mm: Pyörätien jatkeet ja suojatiet'), 150, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 3 mm: Sulkualueet'), 150, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 56'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 3'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pienmerkinnät massalla paksuus 3 mm: Pyörätien jatkeet ja suojatiet'), 11037, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 3'));
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Tiemerkintöjen palvelusopimus KAS ELY 2013 - 2017'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Tiemerkintöjen palvelusopimus KAS ELY 2013 - 2017') AND paasopimus IS null), NOW(), '2013-11-01 00:00:00+02', '2013-11-01 10:00:00+02', 'kokonaishintainen'::toteumatyyppi, 'Seppo Suorittaja', '4153724-6', 'KAS ELY 2013 - 2018 4');
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 4'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Sulkualueet'), 854, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 4'));
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Tiemerkintöjen palvelusopimus KAS ELY 2013 - 2017'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Tiemerkintöjen palvelusopimus KAS ELY 2013 - 2017') AND paasopimus IS null), NOW(), '2013-11-01 00:00:00+02', '2013-11-01 10:00:00+02', 'kokonaishintainen'::toteumatyyppi, 'Seppo Suorittaja', '4153724-6', 'KAS ELY 2013 - 2018 5');
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 5'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Nuolet ja nopeusrajoitusmerkinnät ja väistämisviivat'), 2525, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 5'));
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Tiemerkintöjen palvelusopimus KAS ELY 2013 - 2017'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Tiemerkintöjen palvelusopimus KAS ELY 2013 - 2017') AND paasopimus IS null), NOW(), '2013-11-01 00:00:00+02', '2013-11-01 10:00:00+02', 'kokonaishintainen'::toteumatyyppi, 'Seppo Suorittaja', '4153724-6', 'KAS ELY 2013 - 2018 6');
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES
((SELECT id FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 6'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Muut pienmerkinnät'), 595, (SELECT urakka FROM toteuma WHERE lisatieto = 'KAS ELY 2013 - 2018 6'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 1'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Päällystettyjen teiden palteiden poisto' and poistettu = false), 11, (SELECT urakka FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 1'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 2'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Päällystettyjen teiden palteiden poisto' and poistettu = false), 11, (SELECT urakka FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 2'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 1-2'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Rumpujen korjaus ja uusiminen  600 - 1000 mm' and poistettu = false), 11, (SELECT urakka FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 1-2'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 2-2'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Rumpujen korjaus ja uusiminen  600 - 1000 mm' and poistettu = false), 11, (SELECT urakka FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 2-2'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 3'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Kaivojen ja putkistojen sulatus' and poistettu = false), 11, (SELECT urakka FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 3'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 4'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Opastustaulujen ja opastusviittojen uusiminen -vanhan viitan/opastetaulun uusiminen' and poistettu = false), 11, (SELECT urakka FROM toteuma WHERE lisatieto = 'TRE BLK SSG3 4'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 1'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Päällystettyjen teiden sorapientareen kunnossapito' and poistettu = false), 9, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 1'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 1-2'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Päällystettyjen teiden sorapientareen kunnossapito' and poistettu = false), 9, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 1-2'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 2-1'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Puun poisto raivausjätteineen (taajamassa)' and poistettu = false), 9, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 2-1'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 2-2'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Puun poisto raivausjätteineen (taajamassa)' and poistettu = false), 9, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 2-2'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 3'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Portaiden talvihoito' and poistettu = false), 9, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 3'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 4'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pensaiden täydennysistutus' and poistettu = false), 9, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL TRI PLSI 4'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 1'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Graffitien poisto' and poistettu = false), 15, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 1'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 1-2'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Graffitien poisto' and poistettu = false), 15, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 1-2'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 2-1'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pysäkkikatosten puhdistus' and poistettu = false), 15, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 2-1'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 2-2'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Pysäkkikatosten puhdistus' and poistettu = false), 15, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 2-2'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 3'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Ic 1-ajorat' and poistettu = false), 15, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 3'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 4'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Rumpujen korjaus ja uusiminen <= 600 mm' and poistettu = false), 15, (SELECT urakka FROM toteuma WHERE lisatieto = 'OUL PSK KPNN 4'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'IVL EVL WHT1'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Ib rampit' and poistettu = false), 8, (SELECT urakka FROM toteuma WHERE lisatieto = 'IVL EVL WHT1'));
...
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'IVL EVL WHT1-2'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Ib rampit' and poistettu = false), 8, (SELECT urakka FROM toteuma WHERE lisatieto = 'IVL EVL WHT1-2'));
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Ivalon MHU testiurakka (uusi)'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Ivalon MHU testiurakka (uusi)') AND paasopimus IS null), NOW(), '2020-11-11 00:00:00+02', '2020-11-11 10:00:00+02', 'yksikkohintainen'::toteumatyyppi, 'Seppo Suorittaja', '4153724-6', 'IVL EVL WHT2-1');
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'IVL EVL WHT2-1'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'K2' and poistettu = false), 8, (SELECT urakka FROM toteuma WHERE lisatieto = 'IVL EVL WHT2-1'));
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Ivalon MHU testiurakka (uusi)'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Ivalon MHU testiurakka (uusi)') AND paasopimus IS null), NOW(), '2021-01-11 00:00:00+02', '2021-01-11 10:00:00+02', 'yksikkohintainen'::toteumatyyppi, 'Seppo Suorittaja', '4153724-6', 'IVL EVL WHT2-2');
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'IVL EVL WHT2-2'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'K2' and poistettu = false), 8, (SELECT urakka FROM toteuma WHERE lisatieto = 'IVL EVL WHT2-2'));
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Ivalon MHU testiurakka (uusi)'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Ivalon MHU testiurakka (uusi)') AND paasopimus IS null), NOW(), '2021-01-11 00:00:00+02', '2021-01-11 10:00:00+02', 'yksikkohintainen'::toteumatyyppi, 'Seppo Suorittaja', '4153724-6', 'IVL EVL WHT3');
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'IVL EVL WHT3'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Ic 1-ajorat' and poistettu = false), 8, (SELECT urakka FROM toteuma WHERE lisatieto = 'IVL EVL WHT3'));
INSERT INTO toteuma (lahde, urakka, sopimus, luotu, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto) VALUES ('harja-ui'::lahde, (SELECT id FROM urakka WHERE nimi='Ivalon MHU testiurakka (uusi)'), (SELECT id FROM sopimus WHERE urakka = (SELECT id FROM urakka WHERE nimi='Ivalon MHU testiurakka (uusi)') AND paasopimus IS null), NOW(), '2021-01-11 00:00:00+02', '2021-01-11 10:00:00+02', 'yksikkohintainen'::toteumatyyppi, 'Seppo Suorittaja', '4153724-6', 'IVL EVL WHT4');
INSERT INTO toteuma_tehtava (toteuma, luotu, toimenpidekoodi, maara, urakka_id) VALUES ((SELECT id FROM toteuma WHERE lisatieto = 'IVL EVL WHT4'), NOW(), (SELECT id FROM tehtava WHERE nimi = 'Is 1-ajorat.' and poistettu = false), 8, (SELECT urakka FROM toteuma WHERE lisatieto = 'IVL EVL WHT4'));
...
INSERT INTO toteuma (lahde, urakka, sopimus, alkanut, paattynyt, tyyppi, suorittajan_nimi, suorittajan_ytunnus, lisatieto)
    VALUES ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, '2005-11-11 00:00:00+02', '2005-11-11 00:00:00+02', 'akillinen-hoitotyo'::toteumatyyppi, 'Teppo Tienraivaaja', '4715514-4', 'Äkillinen1'),
           ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, '2005-11-12 00:00:00+02', '2005-11-12 00:00:00+02', 'lisatyo'::toteumatyyppi, 'Teppo Tienraivaaja', '4715514-4', 'Lisätyö1'),
           ('harja-ui'::lahde, urakka_id_oulu_2005_2012, sopimus_id_oulu_2005_2012, '2005-11-15 00:00:00+02', '2005-11-15 00:00:00+02', 'vahinkojen-korjaukset'::toteumatyyppi, 'Teppo Tienraivaaja', '4715514-4', 'Vahkorj1'),
...
INSERT INTO toteuman_reittipisteet (toteuma, reittipisteet) VALUES (
 ...
 ARRAY[
    ROW('2005-11-13 00:03.00',         st_makepoint(453271, 7188395) ::POINT, 2, NULL,
        ARRAY[ROW((SELECT id FROM tehtava Where nimi = 'Auraus ja sohjonpoisto'), 10)::reittipiste_tehtava]::reittipiste_tehtava[],
        ARRAY[]::reittipiste_materiaali[])::reittipistedata,
    ...
    ROW('2005-11-13 00:09.00', st_makepoint(453820, 7189885) ::POINT, 2, NULL,
        ARRAY[ROW((SELECT id FROM tehtava Where nimi = 'Auraus ja sohjonpoisto'),10)]::reittipiste_tehtava[],
	ARRAY[]::reittipiste_materiaali[])::reittipistedata
 ]::reittipistedata[]);
...
VALUES ('harja-ui'::lahde, urakka_id_oulu_2014_2019,
...
INSERT INTO toteuma_tehtava (id, toteuma, luotu, toimenpidekoodi, maara, poistettu, muokkaaja, muokattu, luoja, paivan_hinta, lisatieto, indeksi, urakka_id) VALUES (22248243, 22433645, '2019-02-19 23:28:19.325931', 1369, 28.9495504064974, false, null, null, (SELECT id FROM kayttaja WHERE kayttajanimi='jvh'), null, null, true, urakka_id_oulu_2014_2019);

INSERT INTO toteuma_materiaali (id, toteuma, luotu, materiaalikoodi, maara, poistettu, muokkaaja, muokattu, luoja, urakka_id) VALUES (5390593, 22433645, '2019-02-19 23:28:19.325931', 7, 36, false, NULL, NULL,  (SELECT id FROM kayttaja WHERE kayttajanimi='jvh'), urakka_id_oulu_2014_2019);
