...
INSERT INTO toteuman_reittipisteet (toteuma, reittipisteet) VALUES (
 ...
 ARRAY[
   ROW('2015-02-01 17:01:00.000000', st_makepoint(430595.76308986434,7198842.856960223) ::POINT, 2, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ...
   ROW('2015-02-01 17:11:00.000000', st_makepoint(429525.64469387184,7207785.989269589) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:12:00.000000', st_makepoint(429525.64469387184,7208703.233609011) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:13:00.000000', st_makepoint(429602.081722157,7209544.040920148) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:14:00.000000', st_makepoint(429678.5187504422,7210690.596344425) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:15:00.000000', st_makepoint(429754.95577872737,7211760.714740418) ::POINT, 7, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:16:00.000000', st_makepoint(428531.9633261646,7213442.329362692) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:17:00.000000', st_makepoint(427996.90412816836,7213977.388560688) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:18:00.000000', st_makepoint(427614.71898674243,7214588.88478697) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:19:00.000000', st_makepoint(427156.0968170314,7215276.818041536) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:20:00.000000', st_makepoint(426850.3487038907,7215964.751296103) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL),
   ROW('2015-02-01 17:21:00.000000', st_makepoint(426773.9116756055,7216270.499409243) ::POINT, 1, null, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL)
 ]::reittipistedata[]);
...
INSERT INTO toteuman_reittipisteet (toteuma, reittipisteet) VALUES (
  ...
  ARRAY[
    ROW('2005-10-10 10:00.00', st_makepoint(498919, 7247099) ::POINT, 3, NULL, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL)::reittipistedata,
    ROW('2005-10-10 10:01.00',st_makepoint(499271, 7248395) ::POINT, 3, NULL, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL)::reittipistedata,
    ROW('2005-10-10 10:02.00',st_makepoint(499399, 7249019) ::POINT, 3, NULL, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL)::reittipistedata,
    ROW('2005-10-10 10:03.00',st_makepoint(499820, 7249885) ::POINT, 3, NULL, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL)::reittipistedata,
    ROW('2005-10-10 10:04.00',st_makepoint(498519, 7247299) ::POINT, 3, NULL, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL)::reittipistedata,
    ROW('2005-10-10 10:05.00',st_makepoint(499371, 7248595) ::POINT, 3, NULL, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL)::reittipistedata,
    ROW('2005-10-10 10:06.00',st_makepoint(499499, 7249319) ::POINT, 3, NULL, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL)::reittipistedata,
    ROW('2005-10-10 10:07.00',st_makepoint(499520, 7249685) ::POINT, 3, NULL, ARRAY[]::reittipiste_tehtava[], ARRAY[]::reittipiste_materiaali[],NULL)::reittipistedata
  ]::reittipistedata[]);
