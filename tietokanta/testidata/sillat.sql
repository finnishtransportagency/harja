INSERT INTO silta (tyyppi, siltanro, siltanimi, alue, tr_numero, tr_alkuosa, tr_alkuetaisyys, siltatunnus, siltaid) VALUES (1,  1537, 'Oulujoen silta', ST_GeomFromText('LINESTRING (429718 7211747,   429721 7211866)')::GEOMETRY, 20, 1, 3014, 'O-00001', 112345);
INSERT INTO silta (tyyppi, siltanro, siltanimi, alue, tr_numero, tr_alkuosa, tr_alkuetaisyys, siltatunnus, siltaid) VALUES (1,   902, 'Pyhäjoen silta', ST_GeomFromText('MULTILINESTRING ((429718 7211777,   429721 7211896))')::GEOMETRY, 20, 1, 3134, 'O-00002', 212345);
INSERT INTO silta (tyyppi, siltanro, siltanimi, alue, tr_numero, tr_alkuosa, tr_alkuetaisyys, siltatunnus, siltaid) VALUES (2, 325235, 'Kempeleen testisilta',ST_GeomFromText('LINESTRING(436858.43500000006 7193422.615, 436208.1980000001 7192283.063)')::GEOMETRY, 20, 1, 3174, 'O-00003', 312345);
INSERT INTO silta (tyyppi, siltanro, siltanimi, alue, tr_numero, tr_alkuosa, tr_alkuetaisyys, siltatunnus, siltaid) VALUES (2, 6666, 'Joutsensilta', ST_GeomFromText('LINESTRING (427714 7208942, 427844 7208968, 427948 7209015, 428154 7209152)')::GEOMETRY, 20, 1, 3204, 'O-00004', 412345);
INSERT INTO silta (tyyppi, siltanro, siltanimi, alue, tr_numero, tr_alkuosa, tr_alkuetaisyys, siltatunnus, siltaid) VALUES (2, 7777, 'Kajaanintien silta', ST_GeomFromText('LINESTRING (429377 7210590, 429790 7210633)')::GEOMETRY, 20, 1, 3234, 'O-00005', 512345);
INSERT INTO silta (tyyppi, siltanro, siltanimi, alue, tr_numero, tr_alkuosa, tr_alkuetaisyys, siltatunnus, siltaid) VALUES (2, 7778, 'Pyhäjoen silta', ST_GeomFromText('LINESTRING (429477 7210390, 429290 7215633)')::GEOMETRY, 20, 1, 3334, 'O-00006', 512346);
