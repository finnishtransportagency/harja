...
BEGIN
    ...
    jaljella_osuutta := 1; -- Vähennetään tästä vain rajoitusalueet, koska pohjavesialueet on osittain päällekäisiä
    ...
    IF tieosoitevali IS DISTINCT FROM NULL THEN
        ...
        -- Sitten pohjavesialueet - Pohjavesialueet voivat olla osittain päällekkäisiä.
        -- Joten tällä tietokantarakenteella ei voida määritellä, että paljonko suolaa osuu pohjavesialueen ulkopuolelle.
        -- jaljella_osuus ei siis kerro, että paljonko on pohjavesialueen ulkopuolella, vaan paljonko rajoitusalueen ulkopuolella.
        FOR pa IN
            SELECT *
              FROM pohjavesialue
