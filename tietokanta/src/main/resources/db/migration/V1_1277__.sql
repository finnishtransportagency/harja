...
-- Mahdollistetaan ajoradan ja kaistan tallentaminen paikkaukselle
-- Siivotaan vanha toteutus pois eri pr:ssä
ALTER TABLE paikkaus
    ADD COLUMN tieosoite_laaja TR_OSOITE_LAAJENNETTU;
