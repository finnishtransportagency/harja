...
update lupaus_kustannusennuste_kuukausi_pisteet set paiva = 31, kuvaus = 'Elokuu 31.päivä (2025 urakat)' where "lupaus-id" = 82 and "urakan-alkuvuosi" = 2025 and kuukausi = 8;
update lupaus_kustannusennuste_kuukausi_pisteet set paiva = 31, kuvaus = 'Elokuu 31.päivä (2026 urakat)' where "lupaus-id" = 114 and "urakan-alkuvuosi" = 2026 and kuukausi = 8;
