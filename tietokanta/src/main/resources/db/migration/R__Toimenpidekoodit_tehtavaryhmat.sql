...
UPDATE toimenpidekoodi SET tehtavaryhma = (select id from tehtavaryhma where nimi = 'Kuivatusjärjestelmät (K)'),	jarjestys = 96, ensisijainen = FALSE, muokattu = current_timestamp, muokkaaja = (select id from kayttaja where kayttajanimi = 'Integraatio') WHERE taso = 4 and nimi = 'Rumpujen aukaisu ja muut rumpujen hoitoon liittyvät työt' AND (yksikko = '-' OR yksikko is null) AND emo = (select id from toimenpidekoodi where koodi = '23116') AND poistettu is not true AND piilota is not true;
...
UPDATE toimenpidekoodi SET tehtavaryhma = (select id from tehtavaryhma where nimi = 'Vesakonraivaukset ja puun poisto (V)'),	jarjestys = 64, ensisijainen = FALSE, muokattu = current_timestamp, muokkaaja = (select id from kayttaja where kayttajanimi = 'Integraatio') WHERE taso = 4 and nimi = 'Vesakonraivaus/ha'	AND yksikko = 'ha'  AND emo = (select id from toimenpidekoodi where koodi = '23116') AND poistettu is not true AND piilota is not true;
...
UPDATE toimenpidekoodi SET tehtavaryhma = (select id from tehtavaryhma where nimi = 'Sorapientareet (O)'),	jarjestys = 117, ensisijainen = FALSE, muokattu = current_timestamp, muokkaaja = (select id from kayttaja where kayttajanimi = 'Integraatio') WHERE taso = 4 and nimi = 'Päällystettyjen teiden palteen poisto'	AND yksikko = 'jkm' AND poistettu is not true AND piilota is not true AND emo = (select id from toimenpidekoodi where koodi = '23116');
...
UPDATE toimenpidekoodi SET tehtavaryhma = (select id from tehtavaryhma where nimi = 'Kuumapäällyste (Y1)' and tyyppi = 'alataso') WHERE nimi = 'Muut päällysteiden paikkaukseen liittyvät työt';
...
UPDATE toimenpidekoodi SET jarjestys = 96	WHERE nimi = 'Rumpujen aukaisu ja muut rumpujen hoitoon liittyvät työt' AND tehtavaryhma IS NOT NULL;
