...
ALTER TABLE kan_hairio ADD COLUMN korjaajan_nimi INTEGER; 
ALTER TABLE kan_hairio ADD COLUMN korjauksen_aloitus DATE;
ALTER TABLE kan_hairio ADD COLUMN korjauksen_lopetus DATE;
