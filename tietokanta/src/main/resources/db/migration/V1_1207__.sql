...
-- Lupaus 7
(7, (SELECT id FROM lupausryhma WHERE otsikko = 'Toiminnan suunnitelmallisuus' and "urakan-alkuvuosi" = 2025 and "rivin-tunnistin-selite" = 'Yleinen'), null, 'kustannusennuste', 8, '{10,1,4,6}', 9, 0,
