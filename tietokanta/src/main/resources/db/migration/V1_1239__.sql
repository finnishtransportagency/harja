-- Lisää uudet arvot 'harja-api-ui' ja 'harja-api-ui-korjaus' lahde enumiin
...
ALTER TYPE lahde ADD VALUE 'harja-api-ui-korjaus'; -- Koneellisesti raportoitua on jälkikäteen muokattu käsin
