DROP VIEW pot2_massan_tiedot;
ALTER TYPE kuulamyllyluokka RENAME TO _kml;

CREATE TYPE kuulamyllyluokka AS ENUM
    ('AN5', 'AN7', 'AN10', 'AN14', 'AN19', 'AN30', 'Ei kuulamyllyä');

ALTER TABLE pot2_mk_urakan_massa RENAME COLUMN kuulamyllyluokka TO _kuulamyllyluokka;
ALTER TABLE pot2_mk_urakan_massa ADD kuulamyllyluokka kuulamyllyluokka;

UPDATE pot2_mk_urakan_massa SET kuulamyllyluokka = _kuulamyllyluokka :: TEXT :: kuulamyllyluokka;
...
ALTER TABLE pot2_mk_urakan_massa DROP COLUMN _kuulamyllyluokka;
DROP TYPE _kml;
