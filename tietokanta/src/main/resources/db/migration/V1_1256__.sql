...
WITH profiilirivit (profiili_nimi, laji_koodi, sanktiotyyppi_koodi, soveltuvuuskonteksti, jarjestys) AS (
    VALUES
        ...
        ('teiden-hoito-mhu2026', 'tyon_tekematta_jattaminen', 22, 'laatupoikkeama', 1),
        ('teiden-hoito-mhu2026', 'tyon_tekematta_jattaminen', 23, 'laatupoikkeama', 2),
        ('teiden-hoito-mhu2026', 'asiakirjamerkintojen_paikkansa_pitamattomyys', 0, 'laatupoikkeama', 1),
        ('teiden-hoito-mhu2026', 'muu_sopimuksen_vastainen_toiminta', 0, 'laatupoikkeama', 1),
        ('teiden-hoito-mhu2026', 'pohjavesisuolan_ylitys', 0, 'laatupoikkeama', 1),
        ('teiden-hoito-mhu2026', 'talvisuolan_kokonaiskayton_ylitys', 0, 'laatupoikkeama', 1),
        ('teiden-hoito-mhu2026', 'laskutus_yli_laskutusrajan', 0, 'laatupoikkeama', 1),
        ('teiden-hoito-mhu2026', 'laskutus_ilman_laskutuskelpoisuutta', 0, 'laatupoikkeama', 1),
        ('teiden-hoito-mhu2026', 'vastuuhenkilon_tenttipistemaara_alentuminen', 0, 'laatupoikkeama', 1),
        ('teiden-hoito-mhu2026', 'vastuuhenkilon_vaihto', 0, 'laatupoikkeama', 1),
