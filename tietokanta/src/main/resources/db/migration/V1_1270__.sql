...
ALTER TABLE paikkaus
    ...
    ADD CONSTRAINT yksikko_sallitaanko_null
        CHECK ("paikkaus-tyyppi" = 'paikkaus' OR (("maara" IS NULL OR "maara" = 0) AND "reikapaikkaus-yksikko" IS NULL) OR ("maara" IS NOT NULL AND "reikapaikkaus-yksikko" IS NOT NULL) );
