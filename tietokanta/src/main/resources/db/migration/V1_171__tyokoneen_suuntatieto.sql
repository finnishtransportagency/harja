...
ALTER TABLE tyokonehavainto ADD COLUMN suunta real;
...
BEGIN
  ...
  IF NOT FOUND THEN
     ...
     INSERT INTO tyokonehavainto (jarjestelma, organisaatio, viestitunniste, lahetysaika,
     	    	 		  tyokoneid, tyokonetyyppi, sijainti, urakkaid, sopimusid, tehtavat, suunta)
	    VALUES (jarjestelma_, organisaatioid, viestitunniste_, lahetysaika_, tyokoneid_, tyokonetyyppi_, sijainti_,
	    	    urakkaid_, sopimusid_, tehtavat_, suunta_);
  END IF;
