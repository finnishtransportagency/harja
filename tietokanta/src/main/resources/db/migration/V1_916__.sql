...
-- Koska toteutuneet_kustannukset tauluun tulee uusia rivejä, niin triggerit pitää myös uudistaa
-- Dropataan ensin triggeri johto_ja_hallintokorvaus tauluun
DROP TRIGGER tg_update_paivita_toteutuneet_kustannukset_jjh ON johto_ja_hallintokorvaus;
-- Ja dropataan myös triggeri kustannusarvioitu_tyo tauluun
