...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1029;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 119;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 424;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 411;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 822;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1421;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1423;
...
SET alue = (SELECT alue
            FROM urakka
            WHERE urakkanro = 1433 AND tyyppi = 'hoito' :: URAKKATYYPPI)
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1417;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 365;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1419;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 921;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 124;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1233;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1418;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 819;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 113;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1424;
...
SET alue = (SELECT alue
            FROM urakka
            WHERE urakkanro = 1429 AND tyyppi = 'hoito' :: URAKKATYYPPI)
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1414;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 922;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1405;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 116;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1012;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1034;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1428;
...
SET alue = (SELECT alue
            FROM urakka
            WHERE urakkanro = 1431 AND tyyppi = 'hoito' :: URAKKATYYPPI)
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1420;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 809;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 384;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 820;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1235;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1026;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1422;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 803;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 912;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1231;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 122;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 826;
...
SET alue = (SELECT alue
            FROM urakka
            WHERE urakkanro = 838 AND tyyppi = 'hoito' :: URAKKATYYPPI)
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 837;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 821;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1018;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 349;
...
SET alue = (SELECT alue
            FROM urakka
            WHERE urakkanro = 385 AND tyyppi = 'hoito' :: URAKKATYYPPI)
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 350;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 918;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 322;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 224;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 449;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1225;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1242;
...
SET alue = (SELECT alue
            FROM urakka
            WHERE urakkanro = 1244 AND tyyppi = 'hoito' :: URAKKATYYPPI)
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1232;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 222;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1237;
...
SET alue = (SELECT alue
            FROM urakka
            WHERE urakkanro = 1245 AND tyyppi = 'hoito' :: URAKKATYYPPI)
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1243;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 223;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 448;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 214;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1228;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1025;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 447;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 446;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 436;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 120;
...
SET alue = (SELECT alue
            FROM urakka
            WHERE urakkanro = 385 AND tyyppi = 'hoito' :: URAKKATYYPPI)
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 333;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 823;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1015;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 218;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 217;
...
SET alue = (SELECT alue
            FROM urakka
            WHERE urakkanro = 1240 AND tyyppi = 'hoito' :: URAKKATYYPPI)
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 1229;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 210;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 201;
...
WHERE 'hoito' :: URAKKATYYPPI AND alue IS NULL AND urakkanro = 121;
