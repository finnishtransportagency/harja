...
def ajaTestikannanLuonti (stagenNimi) {
    try {
        ...
        hoidaMahdollisenErrorinKorjaantuminen(stagenNimi, "Github Pipeline ei enää hajoa Jenkinsin testikannan luomiseen")
    } catch (e) {
        hoidaErrori(e.getMessage(), stagenNimi, "Github Pipeline hajosi Jenkinsin testikannan luomiseen")
    }
}
...
def ajaJarJaTestit (stagenNimi) {
    try {
        ...
        hoidaMahdollisenErrorinKorjaantuminen(stagenNimi, "Github Pipeline ei enää hajoa testien ajamiseen/JAR:in luomiseen")
    } catch (e) {
        ...
        hoidaErrori(e.getMessage(), stagenNimi, "Github Pipeline hajosi testien ajamiseen/JAR:in luomiseen")
    } finally {
        // Testitulokset
...
def ajaTestiserverinKanta(stagenNimi) {
    try {
        ...
        hoidaMahdollisenErrorinKorjaantuminen(stagenNimi, "Github Pipeline ei enää hajoa testiserverin kannan luomiseen")
    } catch (e) {
        hoidaErrori(stagenNimi, "Github Pipeline hajosi testiserverin kannan luomiseen: " + e.getMessage())
    }
}
...
def ajaTestiserverinApp(stagenNimi, buildNumber) {
    try {
        ...
        hoidaMahdollisenErrorinKorjaantuminen(stagenNimi, "Github Pipeline ei enää hajoa testiserverin appiksen luomiseen")
    } catch (e) {
        hoidaErrori(stagenNimi, "Github Pipeline hajosi testiserverin appiksen luomiseen")
    }
}
...
def ajaE2ETestit(stagenNimi) {
    try {
        ...
        hoidaMahdollisenErrorinKorjaantuminen(stagenNimi, "Github Pipeline ei enää hajoa E2E testeihin")
        env.E2E_ONNISTUI = true
    } catch (e) {
        env.E2E_ONNISTUI = false
        hoidaErrori(stagenNimi, "Github Pipeline hajosi E2E testeihin")
    } finally {
        junit([testResults: 'test2junit/xml/*.xml'])
    }
}
...
def ajaStagingserverinKanta(stagenNimi) {
    try {
        ...
        hoidaMahdollisenErrorinKorjaantuminen(stagenNimi, "Github Pipeline ei enää hajoa stagingserverin kannan luomiseen")
    } catch (e) {
        hoidaErrori(e.getMessage(), stagenNimi, "Github Pipeline hajosi stagingserverin kannan luomiseen: " + e.getMessage())
    }
}
...
def ajaStagingserverinApp(stagenNimi, buildNumber) {
    try {
        ...
        hoidaMahdollisenErrorinKorjaantuminen(stagenNimi, "Github Pipeline ei enää hajoa stagingserverin appiksen luomiseen")
    } catch (e) {
        hoidaErrori(e.getMessage(), stagenNimi, "Github Pipeline hajosi stagingserverin appiksen luomiseen")
    }
}
...
def ajaTuotantoserverinKanta(stagenNimi) {
    try {
        ...
        hoidaMahdollisenErrorinKorjaantuminen(stagenNimi, "Github Pipeline ei enää hajoa tuotantoserverin kannan luomiseen")
    } catch (e) {
        hoidaErrori(e.getMessage(), stagenNimi, "Github Pipeline hajosi tuotantoserverin kannan luomiseen: " + e.getMessage())
    }
}
