...
(urakka, tapahtunut, kasitelty, tyontekijanammatti, tyontekijanammatti_muu,
 kuvaus, vammat, sairauspoissaolopaivat, sairaalavuorokaudet, tyyppi, luoja, luotu,
...
VALUES
  (:urakka, :tapahtunut, :kasitelty, :ammatti :: tyontekijanammatti, :ammatti_muu,
            :kuvaus, :vammat :: turvallisuuspoikkeama_aiheutuneet_vammat [], :poissa,
