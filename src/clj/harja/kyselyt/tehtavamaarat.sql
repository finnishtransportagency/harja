...
group by tpk.id, tpk.nimi, tpk.yksikko, ut."hoitokauden-alkuvuosi", tpk.jarjestys, tr.nimi, tpk.suunnitteluyksikko
order by tpk.id;
...
group by tpk.id, tpk.nimi, tpk.yksikko, tpk.jarjestys, tr.nimi, tpk.suunnitteluyksikko
order by tpk.id;
