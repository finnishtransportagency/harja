...
SELECT
  ...
  yk.kohdenumero,
  yk.nimi,
  yk.sopimuksen_mukaiset_tyot,
  yk.arvonvahennykset,
  yk.bitumi_indeksi,
  yk.kaasuindeksi,
  yk.poistettu,
  yk.aikataulu_paallystys_alku,
  yk.aikataulu_paallystys_loppu,
  yk.aikataulu_tiemerkinta_alku,
  yk.aikataulu_tiemerkinta_loppu,
  yk.aikataulu_kohde_valmis,
  yk.aikataulu_muokattu,
  yk.aikataulu_muokkaaja,
  yk.valmis_tiemerkintaan,
  yk.tr_numero,
  yk.tr_alkuosa,
  yk.tr_alkuetaisyys,
  yk.tr_loppuosa,
  ...
  yk.yllapitoluokka,
  yk.lahetysaika,
  yk.keskimaarainen_vuorokausiliikenne,
