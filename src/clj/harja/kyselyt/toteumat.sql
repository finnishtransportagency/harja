...
FROM osa_toteumat ot
         ...
         JOIN tehtavaryhma tr_ylataso
              ON tr_valitaso.emo = tr_ylataso.id -- Liimataan välistaso ylätasoon, ja samalla haun tehtäväryhmään eli toimenpiteeseen
...
SELECT ST_LineLocatePoint(v.viiva ::geometry, ST_ClosestPoint(v.viiva ::geometry, :piste ::geometry) ::geometry) AS paikka
