  ...
  [:fo:table {:font-size pdf-raportointi/otsikon-fonttikoko}
   ...
   (let [saraketyyli-yla {:margin-left "8mm" :margin-top "30px" :font-weight "bold"}
     ...
     [:fo:table-body
      ...
      [:fo:table-row
       [:fo:table-cell [:fo:block {:margin-top "6px"} "Palvelumuoto, sulutukset"]]
       ...
       [:fo:table-cell [:fo:block sivusarakkeet-ala "Sulutukset yhteensä: " (liikenneyhteenveto-arvo-str yhteenveto :palvelumuoto :yhteensa)]]]])])
