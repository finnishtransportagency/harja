 ...
 FROM (WITH RECURSIVE kuukaudet (kk) AS (
     ...
     SELECT -- haetaan käytetyt määrät per materiaali ja kk
         ...
         AND t.poistettu IS NOT TRUE
     	   ...
     	   AND (:urakka_annettu is true OR (:urakka_annettu is false AND (:urakkatyyppi_annettu is false OR u.tyyppi = :urakkatyyppi::urakkatyyppi)))
     ...
     SELECT -- Haetaan reittipisteiden toteumat hoitoluokittain
     	 ...
     	 WHERE rm.materiaalikoodi = mk.id
     	   ...
     	   AND (:urakka_annettu is true OR (:urakka_annettu is false AND (:urakkatyyppi_annettu is false OR u1.tyyppi = :urakkatyyppi::urakkatyyppi)))
