    ...
    [:NikuDataBus
     ...
     [:Products
      [:Product {:name                  (apply str (take 80 (or (:nimi (:maksuera maksuera)) "N/A")))
                 ...
                 :managerUserName       "L934498" ;; Aina sama käyttäjä. SAMPO:n määritys. HAR-8804. Vastuuhenkilö lisäkentässä owner_id_t.
       ...
       (custom-information {"owner_id_t"  vastuuhenkilo
                            "vv_tilaus"      (:sampoid (:sopimus maksuera))
