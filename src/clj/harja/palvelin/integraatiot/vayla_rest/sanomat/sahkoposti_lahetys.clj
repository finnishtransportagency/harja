(ns harja.palvelin.integraatiot.vayla-rest.sanomat.sahkoposti-lahetys
  (:require
   [clojure.spec.alpha :as spec]
   [clojure.string :as str])
  (:import (java.util UUID)))

(spec/def ::ei-tyhja-teksti (spec/and string? (complement str/blank?)))
(spec/def ::sahkopostiosoite (spec/and string? #(str/includes? % "@")))
