...
(defn laheta-kuittaus [sonja integraatioloki kuittausjono kuittaus korrelaatio-id tapahtuma-id onnistunut lisatietoja]
    ...
    (try
      (jdbc/with-db-transaction [transaktio db]
        (let [ilmoitus (ilmoitus-sanoma/lue-viesti viestin-sisalto)
          ...
          (laheta-kuittaus sonja integraatioloki kuittausjono kuittaus korrelaatio-id tapahtuma-id true nil)))
      (catch Exception e
        ...
        (let [virhe (str "Poikkeus: " e)
          ...
          (laheta-kuittaus sonja integraatioloki kuittausjono kuittaus korrelaatio-id tapahtuma-id false virhe))))))