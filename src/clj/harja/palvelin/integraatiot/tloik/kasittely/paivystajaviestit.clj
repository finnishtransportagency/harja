...
(defn laheta-ilmoitus-sahkopostilla [email {id :ilmoitus-id :as ilmoitus} {vastaanottaja :sahkoposti :as paivystaja}]
  (if vastaanottaja
    (do
...
(defn laheta [sms email db ilmoitus paivystaja]
  ...
  (laheta-ilmoitus-sahkopostilla email ilmoitus paivystaja))
