...
(defn lue [viesti]
  (let [data (xml/lue viesti)
    ...
    (-> vastaus
        ...
        (cond-> (> (count (z/xml-> data :ns2:tietueet :ns2:tietue)) 1) (assoc :tietueet (vec (parsi-tietueet data))))
        (cond-> (z/xml1-> data :ns2:tietueet) (assoc :tietue (first (parsi-tietueet data)))))))