...
;; Alue
;; {:type :viiva,
;;  :viivat [{:color #object[java.awt.Color 0x266e9735 java.awt.Color[r=0,g=0,b=0]],
;;            :width 6}
;;           {:color #object[java.awt.Color 0x36b38343 java.awt.Color[r=255,g=255,b=0]],
;;            :width 4}],
;;  :ikonit [{:tyyppi :nuoli, :paikka [:taitokset :loppu], :scale 1, :img nil}],
;;  :points ([431460.0691184925 7205319.684948312]
;;           [431454.7928921324 7205310.411034317])},
...
(defmulti piirra (fn [_ toteuma alue] (:tyyppi alue)))
      ...
      (.transform
       ...
       (let [[w h] kuva
         ...
         (doto (AffineTransform.)
           ...
           (.scale sx sy)
           (.translate tx ty))))
      (doseq [{alue :alue :as toteuma} (toteumat db user)
              :when alue]
        (piirra g toteuma alue))
