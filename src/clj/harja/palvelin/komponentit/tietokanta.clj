...
(defn luo-tietokanta
  ...
  ([palvelin portti tietokanta kayttaja salasana] (luo-tietokanta palvelin portti tietokanta kayttaja salasana 16))
  ([palvelin portti tietokanta kayttaja salasana poolin-koko]
   ...
   (->Tietokanta (doto (ComboPooledDataSource.)
                   ...
                   (.setPassword salasana)
                                        ;(.setInitialPoolSize 32)
                   (.setMaxPoolSize poolin-koko)
