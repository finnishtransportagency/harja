...
(defn prosessoi-apikayttaja-header
  "Integraatioväylä välittää apikäyttäjän tunnuksen Harjaan harja_api_username-nimisessä headerissä.
  ...
  [headerit]
  (if (get headerit "harja_api_username")
    (assoc-in headerit ["oam_remote_user"] (get headerit "harja_api_username"))
    headerit))
