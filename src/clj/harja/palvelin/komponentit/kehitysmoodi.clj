...
(def +wmts-mml-url+ "https://harja-test.solitaservices.fi.example.com/harja/integraatiotesti/wmts")
(def +wmts-livi-url+ "https://harja-test.solitaservices.fi.example.com/harja/integraatiotesti/wmtslivi")
