...
(defmethod validoi-saanto :ei-setissa [_ _ data rivi taulukko & [set viesti]]
  (log "Tarkistetaan onko annettu arvo " (pr-str data) " setissä " (pr-str set))
  (when (contains? set data)
    viesti))
