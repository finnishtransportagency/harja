...
;; Rajapinnat gridien komponenteille

(defn grid [opts skeema tiedot]
  (grid-komponentti/grid opts skeema tiedot))

(defn muokkaus-grid [opts skeema muokatut]
  (muokkausgrid/muokkaus-grid opts skeema muokatut))