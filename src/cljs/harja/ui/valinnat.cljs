...
(defn aikavali
  ...
  ([valittu-aikavali-atom asetukset]
   (let [asetukset-atom (atom asetukset)
         aikavalin-alku-muuttuu! (fn [uusi-arvo]
         ...
         aikavalin-loppu-muuttuu! (fn [uusi-arvo]
