...
(defn harja-icon-action-add-attachment [] [:span.harja-icon-action-add-attachment {:alt "lisää liite" :aria-label "lisää liite"}])
(defn harja-icon-action-add-picture [] [:span.harja-icon-action-add-picture {:alt "lisää kuva" :aria-label "lisää kuva"}])
(defn harja-icon-action-add [] [:span.harja-icon-action-add {:alt "lisää" :aria-label "lisää"}])
...
(defn harja-icon-action-clear [] [:span.harja-icon-action-clear {:alt "tyhjennä" :aria-label "tyhjennä"}])
(defn harja-icon-action-copy-lane [] [:span.harja-icon-action-copy-lane])
(defn harja-icon-action-copy [] [:span.harja-icon-action-copy {:alt "kopioi" :aria-label "kopioi"}])
...
(defn harja-icon-action-log-in [] [:span.harja-icon-action-log-in {:alt "kirjaudu sisään" :aria-label "kirjaudu sisään"}])
(defn harja-icon-action-log-out [] [:span.harja-icon-action-log-out {:alt "kirjaudu ulos" :aria-label "kirjaudu ulos"}])
(defn harja-icon-action-message [] [:span.harja-icon-action-message])
(defn harja-icon-action-message-filled [] [:span.harja-icon-action-message-filled {:alt "näytä kommentti" :aria-label "näytä kommentti"}])
...
(defn harja-icon-action-save [] [:span.harja-icon-action-save {:alt "tallenna" :aria-label "tallenna"}])
(defn harja-icon-action-search [] [:span.harja-icon-action-search {:alt "hae" :aria-label "hae"}])
(defn harja-icon-action-send-email [] [:span.harja-icon-action-send-email {:alt "lähetä sähköposti" :aria-label "lähetä sähköposti"}])
(defn harja-icon-action-set-date [] [:span.harja-icon-action-set-date {:alt "aseta päivämäärä" :aria-label "aseta päivämäärä"}])
(defn harja-icon-action-set-favorite [] [:span.harja-icon-action-set-favorite])
(defn harja-icon-action-set-time [] [:span.harja-icon-action-set-time {:alt "aseta aika" :aria-label "aseta aika"}])
(defn harja-icon-action-show-list [] [:span.harja-icon-action-show-list])
(defn harja-icon-action-show-map [] [:span.harja-icon-action-show-map {:alt "näytä kartta" :aria-label "näytä kartta"}])
(defn harja-icon-action-show [] [:span.harja-icon-action-show {:alt "näytä" :aria-label "näytä"}])
(defn harja-icon-action-sort-ascending [] [:span.harja-icon-action-sort-ascending {:alt "järjestä nousevasti" :aria-label "järjestä nousevasti"}])
(defn harja-icon-action-sort-descending [] [:span.harja-icon-action-sort-descending {:alt "järjestä laskevasti" :aria-label "järjestä laskevasti"}])
(defn harja-icon-action-sound-on [] [:span.harja-icon-action-sound-on])
(defn harja-icon-action-subtract [] [:span.harja-icon-action-subtract {:alt "vähennä" :aria-label "vähennä"}])
(defn harja-icon-action-undo [] [:span.harja-icon-action-undo {:alt "peruuta" :aria-label "peruuta"}])
...
(defn harja-icon-misc-clock [] [:span.harja-icon-misc-clock {:alt "aika" :aria-label "aika"}])
...
(defn harja-icon-navigation-close [] [:span.harja-icon-navigation-close {:alt "sulje" :aria-label "sulje"}])
...
(defn harja-icon-navigation-external-link [] [:span.harja-icon-navigation-external-link {:alt "ulkoinen linkki" :aria-label "ulkoinen linkki"}])
...
(defn harja-icon-navigation-home [] [:span.harja-icon-navigation-home {:alt "etusivulle" :aria-label "etusivulle"}])
...
(defn harja-icon-navigation-more [] [:span.harja-icon-navigation-more {:alt "lisää" :aria-label "lisää"}])
(defn harja-icon-navigation-next-page [] [:span.harja-icon-navigation-next-page {:alt "seuraava" :aria-label "seuraava"}])
(defn harja-icon-navigation-notifications [] [:span.harja-icon-navigation-notifications])
(defn harja-icon-navigation-previous-page [] [:span.harja-icon-navigation-previous-page {:alt "edellinen" :aria-label "edellinen"}])
...
(defn harja-icon-status-alert [] [:span.harja-icon-status-alert {:alt "huomio" :aria-label "huomio"}])
...
(defn harja-icon-status-error [] [:span.harja-icon-status-error {:alt "virhe" :aria-label "virhe"}])
