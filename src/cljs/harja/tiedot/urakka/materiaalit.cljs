...
(defn tallenna-toteuma-materiaaleja [urakka-id toteumamateriaalit hoitokausi]
  (k/post! :tallenna-toteuma-materiaaleja! {:urakka-id urakka-id :toteumamateriaalit toteumamateriaalit :hoitokausi hoitokausi}))
