...
(def suunnittelu-default-arvot {:tehtavat {:valinnat {:samat-tuleville false
                                                      ...
                                                      :valitaso nil
                                                      :noudetaan 0}}
                                :tehtavat-maarat {:tallennustila? true
                                                  :avatut-rivit #{"1.0 TALVIHOITO"}}
...
(def paikkaus-default-arvot {:paikkauskohteet {:valitut-tilat #{"Kaikki"}
                             ...
                             :paikkaustoteumat {:valinnat {:aikavali-kuluva (pvm/vuoden-aikavali (pvm/vuosi (pvm/nyt)))
                                                           :aikavali-hoitokausi (pvm/paivamaaran-hoitokausi (pvm/nyt))
                                                           :valitut-tyomenetelmat #{"Kaikki"}}
