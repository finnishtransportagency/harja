...
(def tieliikennekeskusten-sahkopostiosoitteet
  (if (k/kehitysymparistossa?)
    ...
    [["Helsinki" "helsinki.liikennekeskus@fintraffic.fi"]
     ["Oulu" "oulu.liikennekeskus@fintraffic.fi"]
     ["Tampere" "tampere.liikennekeskus@fintraffic.fi"]
     ["Turku" "turku.liikennekeskus@fintraffic.fi"]]))
