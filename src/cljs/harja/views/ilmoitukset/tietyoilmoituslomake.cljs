...
(defn- valitse-tyon-tyyppi [e! _ tyyppi valittu?]
  (get-in
    (e! (tiedot/->PaivitaTyotyypit tyyppi valittu?))
    [:valittu-ilmoitus ::t/tyotyypit]))
...
(defn- tyotyypit [e!]
  (let [osio (fn [nimi otsikko vaihtoehdot e!]
               {:otsikko          otsikko
                :nimi             nimi
                :hae              ::t/tyotyypit
                :aseta            (fn [a b]
                ...
                :valitse-fn       (r/partial valitse-tyon-tyyppi e!)})]
    (lomake/ryhma
      "Työn tyyppi"
      (osio :tyotyypit-a "Tienrakennustyöt" t/tyotyyppi-vaihtoehdot-tienrakennus e!)
      (osio :tyotyypit-b "Huolto- ja ylläpitotyöt" t/tyotyyppi-vaihtoehdot-huolto e!)
      (osio :tyotyypit-c "Asennustyöt" t/tyotyyppi-vaihtoehdot-asennus e!)
      (merge (osio :tyotyypit-d "Muut" t/tyotyyppi-vaihtoehdot-muut e!)
