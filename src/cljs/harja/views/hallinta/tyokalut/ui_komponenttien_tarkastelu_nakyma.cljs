			...
			(let [viesti-ryhman-tiedot viesti/kehityssivun-viesti-esimerkit
				...
				[:div {:class "ui-komponenttien-tarkastelu-nakyma"
				 ...
				 [:section {:class "ui-komponenttien-tarkastelu-sivun-otsikko"}
					...
					[:p "Lisäksi tällä sivulla voi nyt kokeilla jaettuja teeman perusasetuksia, jotka vaikuttavat useaan komponenttiin yhtä aikaa ennen tarkempia komponenttikohtaisia overrideja. Tässä viipaleessa vaikutus näkyy erityisesti tarkastelukorttien pinnoissa, tabsien väreissä, paikallisissa napeissa ja neutraalissa perusviestissä, mukaan lukien hover-tilat."]]
