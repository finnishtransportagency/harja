...
(defn hoidon-sarakkeet []
  [{:otsikko "Tehtävä" :nimi :tehtavan_nimi :tyyppi :string :muokattava? (constantly false) :leveys "30%"}
   {:otsikko (str "Määrä 10-12/" (.getYear (first @u/valittu-hoitokausi))) :nimi :maara-kkt-10-12 :tyyppi :numero :leveys "10%" :validoi [[:nolla-tai-positiivinen-luku-opt]]}
   ...
   {:otsikko (str "Määrä 1-9/" (.getYear (second @u/valittu-hoitokausi))) :nimi :maara-kkt-1-9 :tyyppi :numero :leveys "10%" :validoi [[:nolla-tai-positiivinen-luku-opt]]}
   ...
   {:otsikko (str "Yksikköhinta") :nimi :yksikkohinta :tasaa :oikea :tyyppi :numero :fmt fmt/euro-opt :leveys "10%" :validoi [[:nolla-tai-positiivinen-luku-opt]]}
