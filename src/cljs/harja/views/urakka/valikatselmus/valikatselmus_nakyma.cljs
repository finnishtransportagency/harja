      ...
      (doall
        (for* [paatos paatokset]
          (cond
            ...
            (= (ffirst paatos) :tavoitehinnan-muutokset) [tavoitehinnan-muutokset/tavoitehinnan-muutokset e! (second (first paatos)) oikeudet-muokata? tallennus-kesken? avatut-paatokset (:tavoitehinnan-muutokset app)]
            (= (ffirst paatos) :tavoitehinnan-pysyvat-muutokset) [tavoitehinnan-muutokset/tavoitehinnan-muutokset-2025 e! (second (first paatos)) oikeudet-muokata? tallennus-kesken? avatut-paatokset]
