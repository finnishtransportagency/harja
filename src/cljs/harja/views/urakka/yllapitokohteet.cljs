...
(defn yllapitokohdeosat [{:keys [urakka virheet-atom validoinnit voi-muokata? virhe-viesti rivinumerot? muokattava-ajorata-ja-kaista?
                                 muokattava-tie? jarjesta-kun-kasketaan kohdeosat-atom]}]
...
(defn kohteen-vetolaatikko [{:keys [urakka sopimus-id kohteet-atom rivi]}]
  (let [tallenna-fn (fn [osatyyppi]
        ...
        muut-osat (atom (indeksoi-osat (yllapitokohteet-domain/jarjesta-yllapitokohteet
                                         (filter #(not= (:tr-numero rivi) (:tr-numero %)) (:kohdeosat rivi)))))
