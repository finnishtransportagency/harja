...
(tarkkaile! "PÄÄ Lomakedata: " paallystys/paallystysilmoitus-lomakedata)
...
(defn kasittely
  ...
  (let [muokattava? (and
        ...
        paatostiedot-tekninen-osa (r/wrap {:paatos-tekninen (:paatos_tekninen_osa @paallystys/paallystysilmoitus-lomakedata)
                                           :perustelu-tekninen-osa (:perustelu_tekninen_osa @paallystys/paallystysilmoitus-lomakedata)
                                           :kasittelyaika-tekninen-osa (:kasittelyaika_tekninen_osa @paallystys/paallystysilmoitus-lomakedata)}
                                          (fn [uusi-arvo]
        ...
        paatostiedot-taloudellinen-osa (r/wrap {:paatos-taloudellinen (:paatos_taloudellinen_osa @paallystys/paallystysilmoitus-lomakedata)
                                                :perustelu-taloudellinen-osa (:perustelu_taloudellinen_osa @paallystys/paallystysilmoitus-lomakedata)
                                                :kasittelyaika-taloudellinen-osa (:kasittelyaika_taloudellinen_osa @paallystys/paallystysilmoitus-lomakedata)}
                                               (fn [uusi-arvo]
                                                 (swap! paallystys/paallystysilmoitus-lomakedata
                                                        #(-> %
...
(defn tallennus
  ...
  (let [huomautusteksti (reaction (let [valmispvm-kohde (:valmispvm_kohde @paallystys/paallystysilmoitus-lomakedata)
      ...
      (fn []
        (let [lomakedata-nyt @paallystys/paallystysilmoitus-lomakedata
              kohteen-tiedot (r/wrap {:aloituspvm (:aloituspvm lomakedata-nyt)
                                     ...
                                     (fn [uusi-arvo]
                                       (reset! paallystys/paallystysilmoitus-lomakedata (-> (assoc lomakedata-nyt :aloituspvm (:aloituspvm uusi-arvo))
              ...
              (r/wrap (zipmap (iterate inc 1) (:kiviaines (:ilmoitustiedot lomakedata-nyt)))
                      (fn [uusi-arvo] (reset! paallystys/paallystysilmoitus-lomakedata
                                              (assoc-in @paallystys/paallystysilmoitus-lomakedata [:ilmoitustiedot :kiviaines] (grid/filteroi-uudet-poistetut uusi-arvo)))))
              alustalle-tehdyt-toimet
              (r/wrap (zipmap (iterate inc 1) (:alustatoimet (:ilmoitustiedot lomakedata-nyt)))
                      (fn [uusi-arvo] (reset! paallystys/paallystysilmoitus-lomakedata
                                              (assoc-in @paallystys/paallystysilmoitus-lomakedata [:ilmoitustiedot :alustatoimet] (grid/filteroi-uudet-poistetut uusi-arvo)))))
              toteutuneet-maarat
           ...
           [:fieldset.lomake-osa
            ...
            [grid/muokkaus-grid
             ...
             [{:otsikko "Tie#" :nimi :tie :tyyppi :positiivinen-numero :leveys "10%" :validoi [[:ei-tyhja "Tieto puuttuu"]]
              ...
              {:otsikko "Alku\u00ADetäi\u00ADsyys" :nimi :aet :leveys "10%" :tyyppi :positiivinen-numero :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              {:otsikko "Loppu\u00ADtieosa" :nimi :losa :leveys "10%" :tyyppi :positiivinen-numero :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              {:otsikko "Loppu\u00ADetäi\u00ADsyys" :nimi :let :leveys "10%" :tyyppi :positiivinen-numero :validoi [[:ei-tyhja "Tieto puuttuu"]]}
            ...
            [grid/muokkaus-grid
             ...
             [{:otsikko "Päällyste"
              ...
              {:otsikko "Massa (kg/m2)" :nimi :massa :tyyppi :positiivinen-numero :leveys "10%" :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              ...
              {:otsikko "Pääll. työ\u00ADmenetelmä"
               ...
               :leveys "30%"
               :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              {:otsikko "Leveys (m)" :nimi :leveys :leveys "10%" :tyyppi :positiivinen-numero :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              {:otsikko "Massa (kg/m2)" :nimi :massamaara :leveys "15%" :tyyppi :positiivinen-numero :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              {:otsikko "Pinta-ala (m2)" :nimi :pinta-ala :leveys "10%" :tyyppi :positiivinen-numero :validoi [[:ei-tyhja "Tieto puuttuu"]]}
            ...
            [grid/muokkaus-grid
             ...
             [{:otsikko "Alku\u00ADtieosa" :nimi :aosa :tyyppi :positiivinen-numero :leveys "10%" :pituus-max 256 :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              {:otsikko "Alku\u00ADetäisyys" :nimi :aet :tyyppi :positiivinen-numero :leveys "10%" :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              {:otsikko "Loppu\u00ADtieosa" :nimi :losa :tyyppi :positiivinen-numero :leveys "10%" :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              ...
              {:otsikko "Käsit\u00ADtely\u00ADpaks. (cm)" :nimi :paksuus :leveys "15%" :tyyppi :positiivinen-numero :validoi [[:ei-tyhja "Tieto puuttuu"]]}
           ...
           [:fieldset.lomake-osa
            ...
            [grid/muokkaus-grid
             ...
             [{:otsikko "Päällyste\u00ADtyön tyyppi"
              ...
              {:otsikko "Tilattu määrä" :nimi :tilattu-maara :tyyppi :positiivinen-numero :kokonaisosan-maara 6 :leveys "15%" :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              {:otsikko "Toteu\u00ADtunut määrä" :nimi :toteutunut-maara :leveys "15%" :tyyppi :positiivinen-numero :validoi [[:ei-tyhja "Tieto puuttuu"]]}
              ...
              {:otsikko "Yks.\u00ADhinta" :nimi :yksikkohinta :leveys "10%" :tyyppi :positiivinen-numero :kokonaisosan-maara 4 :validoi [[:ei-tyhja "Tieto puuttuu"]]}
