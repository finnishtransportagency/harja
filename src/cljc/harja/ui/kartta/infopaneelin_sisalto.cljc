  ...
  {:tyyppi :tietyoilmoitus
   ...
   :tiedot [{:otsikko "Ilmoittaja" :hae (hakufunktio
                                          ...
                                          #(str (get-in % [::t-domain/ilmoittaja ::t-domain/etunimi]) " "
                                                (get-in % [::t-domain/ilmoittaja ::t-domain/sukunimi])))}
            ...
            {:otsikko "Urakoitsijan yhteyshenkilo" :hae (hakufunktio
                                                          ...
                                                          #(str (get-in % [::t-domain/urakoitsijayhteyshenkilo ::t-domain/etunimi]) " "
                                                                (get-in % [::t-domain/urakoitsijayhteyshenkilo ::t-domain/sukunimi])))}
            ...
            {:otsikko "Tilaajan yhteyshenkilö" :hae (hakufunktio
                                                      ...
                                                      #(str (get-in % [::t-domain/tilaajayhteyshenkilo ::t-domain/etunimi]) " "
                                                            (get-in % [::t-domain/tilaajayhteyshenkilo ::t-domain/sukunimi])))}
            ...
            {:otsikko "Alku" :nimi ::t-domain/alku}
            {:otsikko "Loppu" :nimi ::t-domain/loppu}
            {:otsikko "Työajat" :hae (hakufunktio
                                                 ::t-domain/tyoajat
                                                 t-domain/tyoajat->str)}
            {:otsikko "Vaikutussuunta" :nimi ::t-domain/vaikutussuunta}
            ...
            {:otsikko "Liikenteenohjaus" :nimi ::t-domain/liikenteenohjaus}
            {:otsikko "Liikenteenohjaaja" :nimi ::t-domain/liikenteenohjaaja}
            {:otsikko "Viivästys normaalisti" :nimi ::t-domain/viivastys-normaali-liikenteessa}
            {:otsikko "Viivästys ruuhkassa" :nimi ::t-domain/viivastys-ruuhka-aikana}
            {:otsikko "Ajoneuvorajoitukset" :hae (hakufunktio
                                         ::t-domain/ajoneuvorajoitukset
                                         t-domain/ajoneuvorajoitukset->str)}
            {:otsikko "Huomautukset" :hae (hakufunktio
                                                   ::t-domain/huomautukset
                                                   t-domain/huomautukset->str)}
            {:otsikko "Ajoittaiset pysäytykset" :hae (hakufunktio
                                                   ::t-domain/ajoittaiset-pysatykset
                                                   t-domain/ajoittaiset-pysatykset->str)}
            {:otsikko "Ajoittain suljettu tie" :hae (hakufunktio
                                                   ::t-domain/ajoittain-suljettu-tie
                                                   t-domain/ajoittain-suljettu-tie->str)}
            {:otsikko "Pysäytysten alku" :nimi ::t-domain/pysaytysten-alku}
            {:otsikko "Pysäytysten loppu" :nimi ::t-domain/pysaytysten-loppu}
            {:otsikko "Lisätietoja" :nimi ::t-domain/lisatietoja}
            {:otsikko "Urakoitsijan nimi" :nimi ::t-domain/urakoitsijan-nimi}
            ]
   :data tietyoilmoitus})
