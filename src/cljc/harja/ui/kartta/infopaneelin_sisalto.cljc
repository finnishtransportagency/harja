...
(defmethod infopaneeli-skeema :kan-hairiotilanne [hairiotilanne]
  {:tyyppi :kan-hairiotilanne
   ...
   :tiedot [{:otsikko "Vikaluokka" :nimi ::ht/vikaluokka :tyyppi :string :fmt ht/fmt-vikaluokka}
            ...
            {:otsikko "Vesiodotusaika" :nimi ::ht/vesiodotusaika-h :tyyppi :string}
            ...
            {:otsikko "Tieodotusaika" :nimi ::ht/tieodotusaika-h :tyyppi :string}
            {:otsikko "Ajoneuvo lkm" :nimi ::ht/ajoneuvo-lkm :tyyppi :string}
