...
(def +kuittauksen-vakiofraasit+
  ["Ajoratamerkinnät tehdään"
   "Keli: Aurataan"
   "Keli: Ei toimenpidetarvetta"
   "Keli: Ennakkosuolataan"
   "Keli: Kiirepäivän TUR-kuittaus"
   "Keli: Linjahiekoitetaan"
   "Keli: Lumivallit madalletaan"
   "Keli: Pinta tasataan"
   "Keli: Pistehiekoitetaan"
   "Keli: Polanne poistetaan"
   "Keli: Selvitetään toimenpidetarv"
   "Keli: Sohjo poistetaan"
   "Keli: Soitetaan tienkäyttäjälle"
   "Keli: Sulamisvesi torjutaan"
   "Keli: Suolataan"
   "Keli: Tarkastetaan ja tehdään tarvittavat toimenpiteet"
   "Keli: Tilanne ohi"
   "Keli: Toimenpiteet alkamassa"
   "Keli: Toimenpiteet  käynnissä"
   "Keli: Toimenpiteet päättyneet"
   "Keli: Viesti vastaanotettu"
   "Keli: Välitetty proj.vastaavalle"
   "Liik: merkit korjataan"
   "Liik: merkit puhdistetaan "
   "Liik: merkit uusitaan"
   "Liik: merkki poistetaan"
   "Liik: ohjauslaite puhdistetaan"
   "Liik: Reunapaalut korjataan"
   "Liik: Reunapaalut pestään"
   "Liik: merkki asennetaan "
   "Puh: Hiekoitushiekka poistetaan"
   "Puh: Roska-astiat tyhjennetään"
   "Puh: Roskat poistetaan"
   "Puh: Töherrykset poistetaan"
   "Rak: Jäätyneet rummut aukaistaan"
   "Rak: Kaiteet korjataan"
   "Rak: Pääll. tien reuna täytetään"
   "Rak: Päällyste paikataan"
   "Rak: Reunakivet korjataan"
   "Rak: Riista-aidat korjataan"
   "Rak: Routaheitto tasataan"
   "Rak: Rummut uusitaan"
   "Rak: Runkokelirikkokohde korjataa"
   "Rak: Sillat pestään"
   "Rak: Tien reunapalteet poistetaan"
   "Rak: Tie ojitetaan (sivuojat jne)"
   "Sora: Pöly sidotaan"
   "Sora: Soratien pinta tasataan"
   "Vih: Niitetään"
   "Vih: Vesakko raivataan"
   "Äkil: hoidetaan liikennöitäväksi"
   "Äkil: Kaatuneet puut raivataan"
   "Äkil: Liikenteenohjaus järjestetään"
   "Äkil: Liikenteenohjaus järjestetään"
   "Äkil: Onnettomuuden raivaus tehdään"
   "Äkil: Tulvavaurio korjataan"])
