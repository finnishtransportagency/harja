...
(defn jarjesta-tehtavat
  ...
  (let [paaryhmat (group-by :paaryhma data)
        ...
        get-paaryhma (fn [nimi] (get (select-keys paaryhmat [nimi]) nimi))

        ;; Hakee ja prosessoi pääryhmät niiden nimen perusteella
        hankintakustannukset (get-paaryhma "hankintakustannukset")
        jjhallinta-kustannukset (get-paaryhma "johto-ja-hallintokorvaus")
        hoidonjohdonpalkkiot (get-paaryhma "hoidonjohdonpalkkio")
        muutokset (get-paaryhma "muutokset")
        erillishankinnat (get-paaryhma "erillishankinnat")
        rahavaraukset (get-paaryhma "rahavaraukset")
        bonukset (get-paaryhma "bonukset")
        siirrot (get-paaryhma "siirto")
        tavoitehinnanoikaisut (get-paaryhma "tavoitehinnanoikaisu")
        tavoitepalkkiot (get-paaryhma "tavoitepalkkio")
        tavoitehinnan-ylitykset (get-paaryhma "tavoitehinnan-ylitys")
        kattohinnan-ylitykset (get-paaryhma "kattohinnan-ylitys")
        sanktiot (get-paaryhma "sanktiot")
        arvonvahennykset (get-paaryhma "arvonvahennykset")
        ulkopuoliset-rahavaraukset (get-paaryhma "ulkopuoliset-rahavaraukset")
        lisatyot (get-paaryhma "lisatyo")
        muutkulut-tavoitehintainen (get-paaryhma "muukulu-tavoitehintainen")
        muutkulut-eitavoitehintainen (get-paaryhma "muukulu-eitavoitehintainen")
