...
(do
  ...
  (do
    (clojure.spec/def
      ...
      (clojure.spec/keys
        :opt
        [:harja.domain.sopimus/paasopimus
         :harja.domain.sopimus/luoja
         :harja.domain.sopimus/id
         :harja.domain.sopimus/loppupvm
         :harja.domain.sopimus/nimi
         :harja.domain.sopimus/harjassa_luotu
         :harja.domain.sopimus/muokattu
         :harja.domain.sopimus/sampoid
         :harja.domain.sopimus/urakoitsija_sampoid
         :harja.domain.sopimus/urakka_sampoid
         :harja.domain.sopimus/alkupvm
         :harja.domain.sopimus/urakka
         :harja.domain.sopimus/muokkaaja
    ...
    (clojure.spec/def
      ...
      (clojure.spec/keys
        ...
        [:harja.domain.sopimus/paasopimus
         ...
         :harja.domain.sopimus/poistettu
         :harja.domain.sopimus/luotu]))
    (clojure.spec/def :harja.domain.sopimus/paasopimus (clojure.spec/nilable :specql.data-types/int4))
    (clojure.spec/def :harja.domain.sopimus/luoja (clojure.spec/nilable :specql.data-types/int4))
    ...
    (clojure.spec/def :harja.domain.sopimus/harjassa_luotu :specql.data-types/bool)
    ...
    (clojure.spec/def :harja.domain.sopimus/urakka (clojure.spec/nilable :specql.data-types/int4))
    (clojure.spec/def :harja.domain.sopimus/muokkaaja (clojure.spec/nilable :specql.data-types/int4))
