(ns harja-laadunseuranta.reitintallennus-test
  (:require [cljs.test :as t :refer-macros [deftest is testing run-tests async]]
            ...
            [harja-laadunseuranta.reitintallennus :as r]
            [harja-laadunseuranta.asetukset :as asetukset])
  (:require-macros [cljs.core.async.macros :refer [go]]
                   [harja-laadunseuranta.indexeddb-macros :refer [with-transaction-to-store with-cursor with-all-items]]
