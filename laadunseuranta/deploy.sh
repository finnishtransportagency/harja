...
MESSAGE="$USER deployasi juuri uuden Harja-laadunseurantatyökalun version haarasta $CURRENT_BRANCH palvelimelle <a href=\"https://$SERVER/laadunseuranta/index.html\">$SERVER/harja/laadunseuranta/index.html</a>"
