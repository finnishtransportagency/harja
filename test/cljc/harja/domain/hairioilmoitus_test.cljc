(ns harja.domain.hairioilmoitus-test
  ...
  (:import (java.util Date)
           (java.time LocalDateTime Month ZoneId Instant ZonedDateTime)))
...
(deftest voimassaoleva-hairio
  ;(with-redefs [pvm/nyt #(pvm/luo-pvm 2020 8 2)]
  (let [hairiot [
                 (hairio 1 true (pvm/dateksi (pvm/paivaa-sitten 2)) (pvm/dateksi (pvm/paivaa-sitten 1)))
...
(deftest voimassaoleva-hairio-ei-yhtaan
  (let [hairiot [
                 (hairio 1 false (pvm/dateksi (pvm/paivaa-sitten 2)) (pvm/dateksi (pvm/paivaa-sitten 1)))
...
(deftest voimassaoleva-hairio-alku-avoin-paattynyt
  (let [hairiot [
                 (hairio 1 true nil (pvm/dateksi (pvm/paivaa-sitten 1)))
                 (hairio 2 true (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 5)) (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 50)))
                 ]
        voimassaoleva (hairio/voimassaoleva-hairio hairiot)
        ]
...
(deftest voimassaoleva-hairio-alku-avoin-voimassa
  (let [hairiot [
                 (hairio 1 true nil (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 5)))
                 (hairio 2 true (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 5)) (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 50)))
                 ]
        voimassaoleva (hairio/voimassaoleva-hairio hairiot)
        ]
...
(deftest aikavalit-eivat-leikkaa-sivuavat
  (let [vanhat [
                (hairio 1 true (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 5)) (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 50)))
                ]
...
(deftest aikavali-leikkaus-uuden-loppu-avoin-ei-leikkaa
  (let [vanhat [
                (hairio 1 true (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 5)) (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 7)))
                ]
        ]
...
(deftest aikavali-leikkaus-vanhan-alku-avoin-leikkaa
  (let [vanhat [
                (hairio 1 true nil (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 1)))
                ]
        ]
...
(deftest aikavali-leikkaus-vanhan-alku-avoin-ei-leikkaa
  (let [vanhat [
                (hairio 1 true nil (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 3)))
                ]
        ]
...
(deftest aikavali-leikkaus-vanhan-loppu-avoin-ei-leikkaa
  (let [vanhat [
                (hairio 1 true (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 5)) nil)
                ]
        ]
    (is (not (hairio/onko-paallekkainen (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 2)) (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 4)) vanhat)))))
...
(deftest aikavali-leikkaus-vanhan-loppu-avoin-leikkaa
  (let [vanhat [
                (hairio 1 true (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 3)) nil)
                ]
        ]
    (is (hairio/onko-paallekkainen (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 2)) (pvm/dateksi (pvm/pvm-plus-tuntia (pvm/nyt) 4)) vanhat))))
