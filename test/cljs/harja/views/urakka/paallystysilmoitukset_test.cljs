...
(deftest tien-pituus-laskettu-oikein
  (let [osat {1 100
    ...
    (is (= (tierekisteri-domain/laske-tieosan-ajoradan-pituus tie1) 2))
    (is (= (tierekisteri-domain/laske-tieosan-ajoradan-pituus tie2) 0))
    (is (= (tierekisteri-domain/laske-tieosan-ajoradan-pituus tie3) 103))
    (is (= (tierekisteri-domain/laske-tieosan-ajoradan-pituus tie4) 1))
    (is (= (tierekisteri-domain/laske-tieosan-ajoradan-pituus tie5) 1))
    (is (= (tierekisteri-domain/laske-tieosan-ajoradan-pituus tie6) nil))
    (is (= (tierekisteri-domain/laske-tieosan-ajoradan-pituus tie7) nil)) ;; Ei voida laskea ilman osien pituutta
    (is (= (tierekisteri-domain/laske-tieosan-ajoradan-pituus osat tie8) 100))
    (is (= (tierekisteri-domain/laske-tieosan-ajoradan-pituus osat tie9) 120))))
