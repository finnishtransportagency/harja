...
(deftest validoi-muut-kohteet-ei-herjaa-itsensa-kanssa-paallekkaisyydesta
  (let [tr-osoite {:tr-kaista nil, :tr-ajorata nil, :tr-loppuosa 404, :tr-alkuosa 363, :tr-loppuetaisyys 2500, :tr-alkuetaisyys 3100, :tr-numero 4}
        muut-kohteet (list
                       {:kohdeosa-id 11067, :tr-kaista 11, :leveys 4, :kokonaismassamaara 1, :tr-ajorata 0, :pinta_ala 1300, :tr-loppuosa 23, :jarjestysnro 1, :tr-alkuosa 23, :tr-loppuetaisyys 850, :tr-alkuetaisyys 525, :piennar false, :tr-numero 28410, :toimenpide 12})
        vuosi 2021
