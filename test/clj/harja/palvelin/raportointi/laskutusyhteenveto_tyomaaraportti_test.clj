...
(defn pura-tyomaaraportti-mapiksi [raportti]
  (let [tulos
        {:talvihoito_hoitokausi_yht (nth raportti 0)
         ...
         :hk_valikatselmus_siirrot_ed_vuodelta (nth raportti 29)
         ...
         :lisatyo_hoidonjohto_hoitokausi_yht (nth raportti 43)
         ...
         :perusluku (nth raportti 61)
         :rahavaraus_nimet (nth raportti 62)
         :hoitokausi_yht_array (nth raportti 63)
         :val_aika_yht_array (nth raportti 64)
         :kaikki_rahavaraukset_hoitokausi_yht (nth raportti 65)
         :kaikki_rahavaraukset_val_yht (nth raportti 66)
         :muut_kulut_hoitokausi (nth raportti 67)
         :muut_kulut_val_aika (nth raportti 68)
         :muut_kulut_hoitokausi_yht (nth raportti 69)
         :muut_kulut_val_aika_yht (nth raportti 70)
         :muut_kulut_ei_tavoite_hoitokausi (nth raportti 71)
         :muut_kulut_ei_tavoite_val_aika (nth raportti 72)
         :muut_kulut_ei_tavoite_hoitokausi_yht (nth raportti 73)
         :muut_kulut_ei_tavoite_val_aika_yht (nth raportti 74)}]
...
(deftest raportin-suoritus-urakalle-toimii
  (let [hk_alkupvm "2019-10-01"
    ...
    (is (= (count (first vastaus)) 75) "Raportilla on oikea määrä rivejä")))
...
(deftest tavoitehinta-toimii
  (let [hk_alkupvm "2019-10-01"
        ...
        urakka-id (hae-oulun-maanteiden-hoitourakan-2019-2024-id)
        tav_hinta 100000M
        ;; Lisää siirretty tavoitehinta "edelliseltä vuodelta"
