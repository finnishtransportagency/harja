...
(deftest raportin-suoritus-urakalle-toimii
  (let [vastaus (kutsu-palvelua (:http-palvelin jarjestelma)
    ...
    (is (= (list ["Oulun alueurakka 2014-2019" 2000M 200M 1800M 2000M 500M 1000M 1000M]
                 (list "Yhteensä" 2000M 200M 1800M 2000M 500M  1000M 1000M))
           rivit))
...
(deftest raportin-suoritus-hallintayksikolle-toimii
         (let [vastaus (kutsu-palvelua (:http-palvelin jarjestelma)
              ...
              (is (= (list ["Kajaanin alueurakka 2014-2019" 2000M 0 2000M 0 0 0 0]
                           ["Oulun alueurakka 2014-2019" 2000M 200M 1800M 2000M 500M 1000M 1000M]
                           (list "Yhteensä" 4000M 200M 3800M 2000M 500M 1000M 1000M))
                     rivit))
              (is (= [:teksti (str "Formiaatteja ei lasketa talvisuolan kokonaiskäyttöön. \n")] (first vinkki)))
              (is (= [:teksti yleinen/materiaalitoteumien-paivitysinfo] (last vinkki)))
              (is (vector? vastaus))
