...
(def odotettu-muut-kustannukset-2017 [:taulukko {:otsikko "Muut kustannukset", :tyhja "Ei muita kustannuksia.", :sheet-nimi "Muut kustannukset"} [{:otsikko "Pvm", :leveys 2, :fmt :pvm} {:leveys  4 :otsikko "Urakka"} {:otsikko "Selitys", :leveys 4} {:otsikko "Summa", :leveys 2, :fmt :raha}] [[(inst/read-instant-timestamp "2017-01-01T22:06:06.370000000-00:00") "Muhoksen päällystysurakka" "Sakko" -1500M] [(inst/read-instant-timestamp "2017-01-01T22:06:06.370000000-00:00") "Muhoksen päällystysurakka" "Sakko: Oulaisten ohitusramppi (yhaid: 456896958)" -1500M] [(inst/read-instant-timestamp "2017-01-02T22:12:06.370000000-00:00") "Muhoksen päällystysurakka" "Sakko: Oulaisten ohitusramppi (yhaid: 456896958)" -1500M] [(inst/read-instant-timestamp "2017-01-02T22:12:06.370000000-00:00") "Muhoksen päällystysurakka" "Bonus: Leppäjärven ramppi (yhaid: 1233534)" 2000M]]])

(def odotettu-yhteenveto-2017
  [:taulukko {:otsikko "Yhteenveto", :tyhja nil, :sheet-nimi "Ylläpitokohteet yhteensä"} (list {:otsikko "", :leveys 5} {:otsikko "", :leveys 5} {:otsikko "", :leveys 3} {:otsikko "", :leveys 3} {:otsikko "", :leveys 3} {:otsikko "", :leveys 3} {:otsikko "", :leveys 3} {:otsikko "Toteu­tunut hinta (muut kohteet)", :nimi :toteutunut-hinta, :fmt :raha, :leveys 5} {:otsikko "Muut kustannukset", :leveys 5, :fmt :raha} {:otsikko "Arvonväh.", :leveys 5, :fmt :raha} {:otsikko "Sakko/bonus", :leveys 5, :fmt :raha} {:otsikko "Tarjous­hinta", :leveys 5, :fmt :raha} {:otsikko "Määrä­muutok­set", :leveys 5, :fmt :raha} {:otsikko "Bitu­mi-indek­si", :leveys 5, :fmt :raha} {:otsikko "Neste­kaasu ja kevyt poltto­öljy", :leveys 5, :fmt :raha} {:otsikko "MAKU-pääl­lys­teet", :leveys 5, :fmt :raha} {:otsikko "Kokonais­hinta", :leveys 5, :fmt :raha}) [(list [:arvo-ja-yksikko-korostettu {:arvo nil, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo nil, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo nil, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo nil, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo nil, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo nil, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo nil, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo 0, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo 0, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo 10671M, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo -1000M, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo 10900M, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo 0, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo 5123.95M, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo 118M, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo 0, :fmt :raha, :korosta-hennosti? true}] [:arvo-ja-yksikko-korostettu {:arvo 25812.95M, :fmt :raha, :korosta-hennosti? true}])]])
...
(def odotettu-PK-luokka-2023
  [:taulukko {:otsikko "Eurot / PK-luokka", :tyhja nil, :sheet-nimi "Eurot / PK-luokka"} '({:otsikko "Urakka", :leveys 10} {:otsikko "PK1", :leveys 2, :fmt :raha} {:otsikko "PK2", :leveys 2, :fmt :raha} {:otsikko "PK3", :leveys 2, :fmt :raha} {:otsikko "Ei tiedossa", :leveys 2, :fmt :raha} {:otsikko "Ei kohdistettu", :leveys 2, :fmt :raha}) '({:otsikko "Pohjois-Suomi"}
                                                                                                                                                                                                                                                                                                                                                         {:lihavoi? false, :rivi [[:arvo {:arvo "Analytiikan testipäällystysurakka", :korosta-hennosti? false}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 98900M, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                         {:lihavoi? false, :rivi [[:arvo {:arvo "Utajärven päällystysurakka", :korosta-hennosti? false}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 7400M, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                         {:lihavoi? true, :rivi [[:arvo {:arvo "Pohjois-Suomi yhteensä", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 106300M, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}]]} {:lihavoi? true, :rivi [[:arvo {:arvo "Valtakunnallisesti yhteensä", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 106300M, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}]]})])
...
(def odotettu-taydennetyt-PKLuokat
  [:taulukko {:otsikko "Eurot / PK-luokka", :tyhja nil, :sheet-nimi "Eurot / PK-luokka"} '({:otsikko "Urakka", :leveys 10} {:otsikko "PK1", :leveys 2, :fmt :raha} {:otsikko "PK2", :leveys 2, :fmt :raha} {:otsikko "PK3", :leveys 2, :fmt :raha} {:otsikko "Ei tiedossa", :leveys 2, :fmt :raha} {:otsikko "Ei kohdistettu", :leveys 2, :fmt :raha}) '({:otsikko "Pohjois-Suomi"}
                                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                                         {:lihavoi? false, :rivi [[:arvo {:arvo "Utajärven päällystysurakka", :korosta-hennosti? false}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 1140M, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                         {:lihavoi? true, :rivi [[:arvo {:arvo "Pohjois-Suomi yhteensä", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 2280M, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}]]} {:lihavoi? true, :rivi [[:arvo {:arvo "Valtakunnallisesti yhteensä", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 2280M, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}]]})])

(def odotettu-yha-kohteet-kokomaa-2023
  [:taulukko {:otsikko "YHA-kohteet" :rivi-ennen [{:sarakkeita 14} {:sarakkeita 1} {:luokka "paallystys-tausta-tumma" :sarakkeita 3 :tasaa :keskita :teksti "Hintamuutokset" :tummenna-teksti? true} {:sarakkeita 1}] :sheet-nimi "YHA-kohteet" :tyhja nil} [{:leveys 10 :otsikko "Urakka"} {:leveys 5 :otsikko "Kohde­numero"} {:leveys 5 :otsikko "Tunnus"} {:leveys 10 :otsikko "Nimi"} {:fmt :boolean :leveys 3 :otsikko "Yö­työ"} {:leveys 3 :otsikko "Tie­numero" :tasaa :oikea} {:leveys 3 :otsikko "Aosa" :tasaa :oikea} {:leveys 3 :otsikko "Aet" :tasaa :oikea} {:leveys 3 :otsikko "Losa" :tasaa :oikea} {:leveys 3 :otsikko "Let" :tasaa :oikea} {:leveys 3 :otsikko "Pit. (m)" :tasaa :oikea} {:leveys 3 :otsikko "KVL" :tasaa :oikea} {:leveys 3 :otsikko "YP-lk"} {:fmt :raha :leveys 5 :otsikko "Tarjous­hinta"} {:fmt :raha :leveys 5 :otsikko "Määrä­muu­tokset"} {:fmt :raha :leveys 5 :otsikko "Bitu­mi-indek­si" :otsikkorivi-luokka "paallystys-tausta-tumma"} {:fmt :raha :leveys 10 :otsikko "Neste­kaasu ja kevyt poltto­öljy" :otsikkorivi-luokka "paallystys-tausta-tumma"} {:fmt :raha :leveys 5 :otsikko "MAKU-pääl­lys­teet" :otsikkorivi-luokka "paallystys-tausta-tumma"} {:fmt :raha :leveys 5 :otsikko "Kokonais­hinta"}] [{:leveys 10 :otsikko "Pohjois-Suomi"} ["Analytiikan testipäällystysurakka" "1" "ANALYTIIKKA1" "Kirkonkylä - Toppinen" [:boolean {:arvo false}] 86 20 0 20 1300 1300 1000 1 100000M -1000M -100M -100M 100M 98900M] ["Utajärven päällystysurakka" "L15" "A" "Puolangantie" [:boolean {:arvo true}] 837 2 0 2 1000 0 nil nil 400M 1000M 5000M 0M 1000M 7400M]]])

(def odotettu-muut-kustannukset-kokomaa-2023
  [:taulukko {:otsikko "Muut kustannukset", :tyhja "Ei muita kustannuksia.", :sheet-nimi "Muut kustannukset"} [{:otsikko "Pvm", :leveys 2, :fmt :pvm} {:leveys  4 :otsikko "Urakka"} {:otsikko "Selitys", :leveys 4} {:otsikko "Summa", :leveys 2, :fmt :raha}] []])

(def odotettu-muut-kohteet-kokomaa-2023
  [:taulukko {:otsikko "Muut kohteet" :rivi-ennen [{:sarakkeita 13} {:sarakkeita 1} {:luokka "paallystys-tausta-tumma" :sarakkeita 3 :tasaa :keskita :teksti "Hintamuutokset" :tummenna-teksti? true} {:sarakkeita 1}] :sheet-nimi "Muut kohteet" :tyhja nil} [{:leveys 10 :otsikko "Urakka"} {:leveys 5 :otsikko "Kohde­numero"} {:leveys 5 :otsikko "Tunnus"} {:leveys 10 :otsikko "Nimi"} {:fmt :boolean :leveys 3 :otsikko "Yö­työ"} {:leveys 3 :otsikko "Tie­numero" :tasaa :oikea} {:leveys 3 :otsikko "Aosa" :tasaa :oikea} {:leveys 3 :otsikko "Aet" :tasaa :oikea} {:leveys 3 :otsikko "Losa" :tasaa :oikea} {:leveys 3 :otsikko "Let" :tasaa :oikea} {:leveys 3 :otsikko "Pit. (m)" :tasaa :oikea} {:leveys 3 :otsikko "KVL" :tasaa :oikea} {:leveys 3 :otsikko "YP-lk"} {:fmt :raha :leveys 10 :otsikko "Toteutunut hinta"} {:fmt :raha :leveys 5 :otsikko "Bitu­mi-indek­si" :otsikkorivi-luokka "paallystys-tausta-tumma"} {:fmt :raha :leveys 10 :otsikko "Neste­kaasu ja kevyt poltto­öljy" :otsikkorivi-luokka "paallystys-tausta-tumma"} {:fmt :raha :leveys 5 :otsikko "MAKU-pääl­lys­teet" :otsikkorivi-luokka "paallystys-tausta-tumma"} {:fmt :raha :leveys 5 :otsikko "Kokonais­hinta"}] [{:leveys 10 :otsikko "Pohjois-Suomi"} ["Analytiikan testipäällystysurakka" "2" nil "MT 86 Paavolantie 2" [:boolean {:arvo false}] 86 20 0 20 100 100 nil nil nil nil nil nil 0]]])

(def odotettu-yotyo-tyhja-2023
  '([:otsikko "Yötyö / PK-luokka"] [:osittain-boldattu-teksti {:boldattu-teksti "Pituus (km)", :teksti " on urakassa ko. PK-luokan kohteille yötyönä tehdyt päällystyskilometrit."}] [:osittain-boldattu-teksti {:boldattu-teksti "Prosenttiosuus", :teksti " on urakassa/ELY:ssä ko. PK-luokan yötyönä tehdyt päällystyskilometrit suhteututtuna kaikkiin päällystyskilometreihin."}] [:taulukko {:tyhja nil, :sheet-nimi "Yötyö / PK-luokka", :rivi-ennen [{:sarakkeita 1, :leveys 8} {:teksti "PK1 yötyö", :sarakkeita 2, :luokka "paallystys-tausta-tumma", :tummenna-teksti? true, :tasaa :keskita} {:teksti "PK2 yötyö", :sarakkeita 2, :tummenna-teksti? true, :tasaa :keskita} {:teksti "PK3 yötyö", :sarakkeita 2, :luokka "paallystys-tausta-tumma", :tummenna-teksti? true, :tasaa :keskita} {:teksti "Ei tiedossa yötyö", :sarakkeita 2, :tummenna-teksti? true, :tasaa :keskita}]} ({:otsikko "Urakka", :leveys 8} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen}) ({:otsikko "Pohjois-Suomi"}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? false, :rivi [[:arvo {:arvo "Analytiikan testipäällystysurakka", :korosta-hennosti? false}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? false, :rivi [[:arvo {:arvo "Utajärven päällystysurakka", :korosta-hennosti? false}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? true, :rivi [[:arvo {:arvo "Pohjois-Suomi yht. / KA%", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]} {:lihavoi? true, :rivi [[:arvo {:arvo "Valtakun. yht. / KA%", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]})]))

(def odotettu-ei-yotoita-2023
  '([:otsikko "Yötyö / PK-luokka"] [:osittain-boldattu-teksti {:boldattu-teksti "Pituus (km)", :teksti " on urakassa ko. PK-luokan kohteille yötyönä tehdyt päällystyskilometrit."}] [:osittain-boldattu-teksti {:boldattu-teksti "Prosenttiosuus", :teksti " on urakassa/ELY:ssä ko. PK-luokan yötyönä tehdyt päällystyskilometrit suhteututtuna kaikkiin päällystyskilometreihin."}] [:taulukko {:tyhja nil, :sheet-nimi "Yötyö / PK-luokka", :rivi-ennen [{:sarakkeita 1, :leveys 8} {:teksti "PK1 yötyö", :sarakkeita 2, :luokka "paallystys-tausta-tumma", :tummenna-teksti? true, :tasaa :keskita} {:teksti "PK2 yötyö", :sarakkeita 2, :tummenna-teksti? true, :tasaa :keskita} {:teksti "PK3 yötyö", :sarakkeita 2, :luokka "paallystys-tausta-tumma", :tummenna-teksti? true, :tasaa :keskita} {:teksti "Ei tiedossa yötyö", :sarakkeita 2, :tummenna-teksti? true, :tasaa :keskita}]} ({:otsikko "Urakka", :leveys 8} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen}) ({:otsikko "Pohjois-Suomi"}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? false, :rivi [[:arvo {:arvo "Analytiikan testipäällystysurakka", :korosta-hennosti? false}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? false, :rivi [[:arvo {:arvo "Utajärven päällystysurakka", :korosta-hennosti? false}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? true, :rivi [[:arvo {:arvo "Pohjois-Suomi yht. / KA%", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]} {:lihavoi? true, :rivi [[:arvo {:arvo "Valtakun. yht. / KA%", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]})]))

(def odotettu-yotyo-pk2-2023
  '([:otsikko "Yötyö / PK-luokka"] [:osittain-boldattu-teksti {:boldattu-teksti "Pituus (km)", :teksti " on urakassa ko. PK-luokan kohteille yötyönä tehdyt päällystyskilometrit."}] [:osittain-boldattu-teksti {:boldattu-teksti "Prosenttiosuus", :teksti " on urakassa/ELY:ssä ko. PK-luokan yötyönä tehdyt päällystyskilometrit suhteututtuna kaikkiin päällystyskilometreihin."}] [:taulukko {:tyhja nil, :sheet-nimi "Yötyö / PK-luokka", :rivi-ennen [{:sarakkeita 1, :leveys 8} {:teksti "PK1 yötyö", :sarakkeita 2, :luokka "paallystys-tausta-tumma", :tummenna-teksti? true, :tasaa :keskita} {:teksti "PK2 yötyö", :sarakkeita 2, :tummenna-teksti? true, :tasaa :keskita} {:teksti "PK3 yötyö", :sarakkeita 2, :luokka "paallystys-tausta-tumma", :tummenna-teksti? true, :tasaa :keskita} {:teksti "Ei tiedossa yötyö", :sarakkeita 2, :tummenna-teksti? true, :tasaa :keskita}]} ({:otsikko "Urakka", :leveys 8} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen, :otsikkorivi-luokka "paallystys-tausta-tumma"} {:otsikko "Pituus (km)", :leveys 2, :fmt :numero, :tasaa :oikea} {:otsikko "Prosenttiosuus", :leveys 3, :fmt :prosentti, :tasaa :vasen}) ({:otsikko "Pohjois-Suomi"}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? false, :rivi [[:arvo {:arvo "Analytiikan testipäällystysurakka", :korosta-hennosti? false}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 100, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 100, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? false, :rivi [[:arvo {:arvo "Utajärven päällystysurakka", :korosta-hennosti? false}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 100, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 100, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? false, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? false, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? true, :rivi [[:arvo {:arvo "Pohjois-Suomi yht. / KA%", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 200, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 100, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              {:lihavoi? true, :rivi [[:arvo {:arvo "Valtakun. yht. / KA%", :korosta-hennosti? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 200, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 100, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}] [:arvo {:arvo 0, :jos-tyhja "", :korosta-hennosti? true, :desimaalien-maara 2, :ryhmitelty? true}] [:arvo-ja-yksikko {:arvo 0, :jos-tyhja "", :yksikko "%", :korosta-hennosti? true, :desimaalien-maara 2, :tasaa :vasen, :ryhmitelty? true}]]})]))
...
(deftest raportin-suoritus-urakalle-toimii-vuosi-2017
  (let [vastaus (kutsu-palvelua (:http-palvelin jarjestelma)
        ...
        muut-kohteet (-> vastaus (nth 4))
        muut-kustannukset (-> vastaus (nth 6))
        yhteenveto (-> vastaus (nth 9))
        aikataulu-otsikko (-> vastaus (nth 7) first)
...
(deftest generoitu-yotyo-pk-luokka-toimii-vuosi-2023
  (let [;; Lokaalikannassa ei ole pituuksia eri pk-luokille defaulttina
        ...
        tyhjat-yotyot (-> vastaus-tyhja (nth 13))
        _ (is (= tyhjat-yotyot odotettu-yotyo-tyhja-2023))

        ;; Laitetaan pituudet vuoden 2023 yllapitokohteille
        yllapitokohteet-2023 (q-map (str "SELECT id, nimi, pkluokka, yotyo FROM yllapitokohde WHERE '2023' = ANY (vuodet);"))

        ;; Riippumatta niiden määrästä, merkitään kaikkien pituudeksi 100m ja pkluokaksi = 1 ja yotyo = false
        _ (mapv
            #(u (format "UPDATE yllapitokohde SET tr_numero = 4, tr_alkuosa = 10, tr_alkuetaisyys = 0,
            tr_loppuosa = 101, tr_loppuetaisyys = 100, pkluokka = 'PK1', yotyo = false WHERE id = %s;" (:id %)))
            yllapitokohteet-2023)
        yllapitokohteet-2023 (q-map (str "SELECT id, nimi, pkluokka, yotyo FROM yllapitokohde WHERE '2023' = ANY (vuodet);"))
        ...
        yotyot-false (-> vastaus-ei-yotoita (nth 13))
        _ (is (= yotyot-false odotettu-ei-yotoita-2023))

        ;; Merkitään kaikki 2023 kohteet yötöiksi ja PK2:Selle
        _ (mapv
            #(u (format "UPDATE yllapitokohde SET tr_numero = 4, tr_alkuosa = 10, tr_alkuetaisyys = 0,
            tr_loppuosa = 101, tr_loppuetaisyys = 100, pkluokka = 'PK2', yotyo = true WHERE id = %s;" (:id %)))
            yllapitokohteet-2023)
        ...
        _ (is (= yotyot-pk2 odotettu-yotyo-pk2-2023))]))
