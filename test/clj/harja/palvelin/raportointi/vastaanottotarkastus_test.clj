...
(def odotettu-PK-luokka-2023
  [:taulukko {:otsikko "Eurot / PK-luokka", :tyhja nil, :sheet-nimi "Eurot / PK-luokka"} '({:otsikko "Urakka", :leveys 10} {:otsikko "PK1", :leveys 2, :fmt :raha} {:otsikko "PK2", :leveys 2, :fmt :raha} {:otsikko "PK3", :leveys 2, :fmt :raha} {:otsikko "Ei tiedossa", :leveys 2, :fmt :raha} {:otsikko "Ei kohdistettu", :leveys 2, :fmt :raha}) '({:otsikko "Pohjois-Pohjanmaa"}
