...
(deftest raportin-suoritus-urakan-kaikille-silloille-toimii
  (let [vastaus (kutsu-palvelua (:http-palvelin jarjestelma)
                                ...
                                {:nimi :siltatarkastus
                                 ...
                                 :parametrit {:vuosi 2007
                                              :silta-id :kaikki}})
        odotettu [:raportti {:orientaatio :landscape, :nimi "Siltatarkastusraportti" :rajoita-pdf-rivimaara nil} [:taulukko {:otsikko "Siltatarkastusraportti, Oulun alueurakka 2005-2012 vuodelta 2007", :tyhja "Sillalle ei ole tehty tarkastusta valittuna vuonna.", :viimeinen-rivi-yhteenveto? true, :sheet-nimi "Siltatarkastusraportti"} [{:leveys 5, :otsikko "Siltanumero"} {:leveys 10, :otsikko "Silta"} {:leveys 5, :otsikko "Tarkastettu", :fmt :pvm} {:leveys 5, :otsikko "Tarkastaja"} {:leveys 5, :otsikko "A"} {:leveys 5, :otsikko "B"} {:leveys 5, :otsikko "C"} {:leveys 5, :otsikko "D"} {:leveys 5, :otsikko "Liitteet"}] [{:rivi [902 "Pyhäjoen silta" #inst "2007-05-04T21:00:00.000000000-00:00" "Mari Mittatarkka" [:arvo-ja-osuus {:arvo 20, :osuus 83}] [:arvo-ja-osuus {:arvo 2, :osuus 8}] [:arvo-ja-osuus {:arvo 1, :osuus 4}] [:arvo-ja-osuus {:arvo 1, :osuus 4}] [:liitteet []]], :virhe? true, :tarkastamaton? false, :korosta? false, :korosta-harmaa? true, :lihavoi? false, :siirtynyt? true} {:rivi [1537 "Oulujoen silta" #inst "2007-02-24T22:00:00.000000000-00:00" "Sirkka Sillankoestaja" [:arvo-ja-osuus {:arvo 20, :osuus 83}] [:arvo-ja-osuus {:arvo 2, :osuus 8}] [:arvo-ja-osuus {:arvo 1, :osuus 4}] [:arvo-ja-osuus {:arvo 1, :osuus 4}] [:liitteet []]], :virhe? true, :tarkastamaton? false, :korosta? false, :korosta-harmaa? true, :lihavoi? false, :siirtynyt? true} {:rivi [0 "Tekaistu kuntasilta" "Silta ei ole urakan vastuulla" "-" [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:liitteet []]], :virhe? false, :tarkastamaton? false, :korosta? false, :korosta-harmaa? true :lihavoi? false, :siirtynyt? true} {:rivi [6666 "Joutsensilta" "Silta ei ole urakan vastuulla" "-" [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:liitteet []]], :virhe? false, :tarkastamaton? false, :korosta? false, :korosta-harmaa? true :lihavoi? false, :siirtynyt? true} {:rivi [7777 "Kajaanintien silta" "Silta ei ole urakan vastuulla" "-" [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:liitteet []]], :virhe? false, :tarkastamaton? false, :korosta? false, :korosta-harmaa? true, :lihavoi? false, :siirtynyt? true} {:rivi [7778 "Pyhäjoen silta" "Silta ei ole urakan vastuulla" "-" [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:liitteet []]], :virhe? false, :tarkastamaton? false, :korosta? false, :korosta-harmaa? true, :lihavoi? false, :siirtynyt? true} {:rivi [325235 "Kempeleen testisilta" "Silta ei ole urakan vastuulla" "-" [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:arvo-ja-osuus {:arvo 0, :osuus 0}] [:liitteet []]], :virhe? false, :tarkastamaton? false, :korosta? false, :korosta-harmaa? true :lihavoi? false, :siirtynyt? true} ["Yhteensä" nil nil nil [:arvo-ja-osuus {:arvo 40, :osuus 83}] [:arvo-ja-osuus {:arvo 4, :osuus 8}] [:arvo-ja-osuus {:arvo 2, :osuus 4}] [:arvo-ja-osuus {:arvo 2, :osuus 4}] [:liitteet nil]]]] nil [:yhteenveto [["Siltoja urakassa" 7] ["Tarkastettu 2007" "2 (28,6 %)"] ["Tarkastamatta 2007" "5 (71,4 %)"]]]]]
    (is (= odotettu vastaus))
    (is (vector? vastaus))
    (is (= 5 (count vastaus)))))
