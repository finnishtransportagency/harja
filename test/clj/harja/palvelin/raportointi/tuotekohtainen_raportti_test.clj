...
;; TODO Ei mene ci/cd:ssä läpi, mutta lokaalisti menee kannan ajon jälkeen
;;      cache???
#_(deftest tuotekohtainen-laskutusyhteenveto-2019-oulu-sql-toimii
...
;; TODO Ei mene ci/cd:ssä läpi, mutta lokaalisti menee kannan ajon jälkeen
;;      cache???
#_(deftest tuotekohtainen-laskutusyhteenveto-2025-ii-sql-toimii
...
;; TODO Ei mene ci/cd:ssä läpi, mutta lokaalisti menee kannan ajon jälkeen
;;      cache???
#_(deftest tuotekohtainen-laskutusraja-2025-mhu+toimii
    (let [hk_alkupvm "2025-10-01"
          hk_loppupvm "2026-09-30"
          aikavali_alkupvm "2025-10-01"
          aikavali_loppupvm "2026-09-30"
...
;; TODO Ei mene ci/cd:ssä läpi, mutta lokaalisti menee kannan ajon jälkeen
;;      cache???
#_(deftest tuotekohtainen-mhu2021-ei-nayta-laskutusrajaa
