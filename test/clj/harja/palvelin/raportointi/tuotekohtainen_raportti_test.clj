...
(deftest tuotekohtainen-laskutusyhteenveto-raportti-toimii
  ...
  (let [vastaus (kutsu-palvelua (:http-palvelin jarjestelma)
        ...
        talvihoito-yhteensa (-> (first laskutusyhteenveto) (nth 3) (nth 3) second second :arvo)
        liikenneymp-yhteensa (-> (second laskutusyhteenveto) (nth 3) (nth 3) second second :arvo)
        soratiet-yhteensa (-> (nth laskutusyhteenveto 2) (nth 3) (nth 3) second second :arvo)
