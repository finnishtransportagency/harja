...
(deftest raportin-suoritus-urakalle-toimii-hoitokausi-2016-2017
  (let [vastaus (kutsu-palvelua (:http-palvelin jarjestelma)
    ...
    (let [odotettu-otsikko "Oulun alueurakka 2014-2019, 01.10.2016-30.09.2017"
      ...
      (is (= indeksitarkistukset-sanktiot "-191,16"))
      (is (= indeksitarkistukset-muut-kuin-kokhint "-167,62"))
      (is (= indeksitarkistukset-kaikki "-167,62"))
      (is (= kaikki-paitsi-kokhint-yhteensa "5 790,68"))
      (is (= kaikki-yhteensa nurkkasumma "5 790,68")))))
...
(deftest raportin-suoritus-pop-elylle-toimii-hoitokausi-2016-2017
  (let [vastaus (kutsu-palvelua (:http-palvelin jarjestelma)
    ...
    (let [odotettu-otsikko "Pohjois-Pohjanmaa, 01.10.2016-30.09.2017"
      ...
      (is (= yks-hint "7 882,50"))
      (is (= sanktiot "-1 900,67"))
      (is (= sanktioiden-indeksitarkistukset "-191,16"))
      (is (= muiden-kuin-kokhint-indeksitarkistukset "-167,62"))
      (is (= kaikki-indeksitarkistukset "-167,62"))
      (is (= kaikki-paitsi-kokhint-yhteensa "5 790,68"))
      (is (= kaikki-yhteensa nurkkasumma "5 790,68")))))