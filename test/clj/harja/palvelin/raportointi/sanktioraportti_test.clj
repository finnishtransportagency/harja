...
(deftest raportin-suoritus-urakalle-toimii
  (let [vastaus (kutsu-palvelua (:http-palvelin jarjestelma)
    ...
    (is (vector? vastaus))
    (is (= vastaus [:raportti {:nimi "Sanktioiden yhteenveto" :sheet-nimi "Sanktioiden yhteenveto" :orientaatio :landscape} [:taulukko {:otsikko "Oulun alueurakka 2014-2019, Sanktioiden yhteenveto ajalta 01.10.2011 - 01.10.2016" :oikealle-tasattavat-kentat #{1}} [{:otsikko "", :leveys 12} {:otsikko "Oulun alueurakka 2014-2019", :leveys 15}] [{:otsikko "Talvihoito"} ["Muistutukset (kpl)" 1] ["Sakko A (€)" "1000,00"] ["- Päätiet (€)" "1000,00"] ["- Muut tiet (€)" "0,00"] ["Sakko B (€)" "666,67"] ["- Päätiet (€)" "666,67"] ["- Muut tiet (€)" "0,00"] ["Talvihoito, sakot yht. (€)" "1666,67"] ["Talvihoito, indeksit yht. (€)" "1674,11"] {:otsikko "Muut tuotteet"} ["Muistutukset (kpl)" 1] ["Sakko A (€)" "0,00"] ["- Liikenneymp. hoito (€)" "0,00"] ["- Sorateiden hoito (€)" "0,00"] ["Sakko B (€)" "111,00"] ["- Liikenneymp. hoito (€)" "110,00"] ["- Sorateiden hoito (€)" "0,00"] ["Muut tuotteet, sakot yht. (€)" "111,00"] ["Muut tuotteet, indeksit yht. (€)" "111,50"] {:otsikko "Ryhmä C"} ["Ryhmä C, sakot yht. (€)" "123,00"] ["Ryhmä C, indeksit yht. (€)" "123,55"] {:otsikko "Yhteensä"} ["Muistutukset yht. (kpl)" 2] ["Indeksit yht. (€)" "1909,16"] ["Kaikki sakot yht. (€)" "1900,67"] ["Kaikki yht. (€)" "3809,83"]]]]))))
