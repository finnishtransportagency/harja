(ns harja.palvelin.integraatiot.yha-velho.yha-velho-test
  (:require [clojure.test :refer :all]
            ...
            [harja.palvelin.integraatiot.yha-velho.tyokalut :refer :all]
                    ...
                    (component/start
                      (component/system-map
                        ...
                        :yha-velho-integraatio (component/using
                                           (yha-velho-integraatio/->YhaVelho {:url +yha-velho-url+})
                                           [:db :integraatioloki])
                        ...
                        :velho-integraatio (component/using
                                           (velho-integraatio/->Velho {:url +yha-url+})
                                           [:db :integraatioloki])))))
