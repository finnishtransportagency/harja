...
(deftest tarkista-lkp-tilinnumeron-paattely
  ...
  (is (= "12980010" (valitse-lpk-tilinumero 1 nil 242))
      "Oikea LKP-tilinnumero valittu toimenpidekoodin perusteella")
  (is (= "12980010" (valitse-lpk-tilinumero 1 nil 318))
      "Oikea LKP-tilinnumero valittu toimenpidekoodin perusteella")
  (is (thrown? RuntimeException (valitse-lpk-tilinumero 1 nil nil))
      "Jos LKP-tuotenumeroa ei voida päätellä, täytyy aiheutua poikkeus")
  (is (thrown? RuntimeException (valitse-lpk-tilinumero 1 nil 1))
      "Jos LKP-tuotenumeroa ei voida päätellä, täytyy aiheutua poikkeus"))
