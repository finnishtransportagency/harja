...
(deftest tarkista-urakkatyypin-paattely-tieurakoille
...
(deftest tarkista-urakkatyyppin-paattely-vesivaylaurakoille
  ...
  (is (= "vesivayla-ruoppaus" (urakkatyyppi/urakkatyyppi "VYR")) "Vesiväylän ruokkausurakka päätellään oikein")
  (is (= "vesivayla-turvalaitteiden-korjaus" (urakkatyyppi/urakkatyyppi "VYT")) "Vesivälyän turvalaitteiden korjausurakka päätellään oikein")
  (is (= "vesivayla-kanavien-hoito" (urakkatyyppi/urakkatyyppi "VHK")) "Vesiväylän kanavan hoitourakka päätellään oikein")
  (is (= "vesivayla-kanavien-korjaus" (urakkatyyppi/urakkatyyppi "VYK"))) "Vesiväylän kanavien korjausurakka päätellään oikein")

(deftest tarkista-urakkatyypin-erikoistapaukset
