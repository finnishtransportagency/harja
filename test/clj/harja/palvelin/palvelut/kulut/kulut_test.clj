...
(deftest hae-kulu-testi
  (let [
    ...
    (is (= (:nimi (:tehtava (first (:kohdistukset kulu-kohdistuksineen)))) "Runkopuiden poisto") "Kulukohdistuksen tehtävän nimi palautuu.")))
...
(def odotettu-kulu_kohdistus-id-9
  {:maksuera-numero 115 :id 9, :tyyppi "lisatyo", :tavoitehintainen false,
