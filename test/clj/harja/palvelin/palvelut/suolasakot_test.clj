...
(deftest hae-urakan-suolasakot-ja-lampotilat-test
  (let [urakka-id @oulun-alueurakan-2014-2019-id
        ...
        hoitokauden-alkupvm (java.sql.Date. 114 9 1)        ;;1.10.2014
        hoitokauden-loppupvm (java.sql.Date. 115 8 30)      ;;30.9.2015
        ]
...
(deftest tallenna-suolasakko-ja-lampotilat-test
  (let [urakka-id @oulun-alueurakan-2014-2019-id
        hoitokauden-alkupvm (java.sql.Date. 115 9 1)        ;;1.10.2015
        hoitokauden-loppupvm (java.sql.Date. 116 8 30)      ;;30.9.2016
        tallennettava-suolasakko {:maksukuukausi 6 :indeksi "MAKU 2005" :maara 40 :keskilampotila -16
