...
(deftest hae-urakan-muutostiedot-ii-kun-annetuilla-ehdoilla-ei-loydy
  (let [urakka-id (hae-urakan-id-nimella "Iin MHU 2021-2026")
        ...
        odotetut-rivit []]
    (is (= (count vastaus-22-23) 0) "oikea määrä muutoksia 22-23")
    (is (= (count vastaus-23-24) 0) "oikea määrä muutoksia 23-24")
    (is (= (count vastaus-24-25) 0) "oikea määrä muutoksia 24-25")
    (is (= odotetut-rivit vastaus-22-23 vastaus-23-24 vastaus-24-25))))
