...
(deftest hae-asioita-tilannekuvaan
  (let [vastaus (hae-tk hakuargumentit-laaja-historia)]
    ...
    (is (= (count (:laatupoikkeamat vastaus)) 49))
...
(deftest hae-urakat-tilannekuvaan-jvh
  (let [vastaus (hae-urakat-tilannekuvaan +kayttaja-jvh+ hakuargumentit-laaja-historia)
        ...
        odotettu-ilman-alueita '({:tyyppi :paallystys, :hallintayksikko {:id 7, :nimi "Kaakkois-Suomi", :elynumero 3}, :urakat ({:id 19, :nimi "Tienpäällystysurakka KAS ELY 1 2015", :urakkanro "TIEPAA124"})}
                                 {:tyyppi :paallystys, :hallintayksikko {:id 12, :nimi "Pohjois-Pohjanmaa", :elynumero 12}, :urakat ({:id 5, :nimi "Muhoksen päällystysurakka", :urakkanro "muho1"} {:id 8, :nimi "YHA-päällystysurakka", :urakkanro "YHA1"} {:id 7, :nimi "Utajärven päällystysurakka", :urakkanro "uta1"} {:id 28, :nimi "Aktiivinen Oulu Päällystys Testi", :urakkanro "ouluPaa"} {:id 24, :nimi "Oulun päällystyksen palvelusopimus", :urakkanro "3003"} {:id 10, :nimi "YHA-päällystysurakka (sidottu)", :urakkanro "YHA3"})}
                                 {:tyyppi :hoito, :hallintayksikko {:id 12, :nimi "Pohjois-Pohjanmaa", :elynumero 12}, :urakat ({:id 1, :nimi "Oulun alueurakka 2005-2012", :urakkanro "1250"} {:id 4, :nimi "Oulun alueurakka 2014-2019", :urakkanro "1238"} {:id 36, :nimi "Iin MHU 2021-2026", :urakkanro "1248"} {:id 27, :nimi "Aktiivinen Kajaani Testi", :urakkanro "12502"} {:id 35, :nimi "Oulun MHU 2019-2024", :urakkanro "1238"} {:id 26, :nimi "Aktiivinen Oulu Testi", :urakkanro "12501"} {:id 21, :nimi "Kajaanin alueurakka 2014-2019", :urakkanro "1236"} {:id 2, :nimi "Pudasjärven alueurakka 2007-2012", :urakkanro "1229"})}
                                 {:tyyppi :valaistus, :hallintayksikko {:id 12, :nimi "Pohjois-Pohjanmaa", :elynumero 12}, :urakat ({:id 16, :nimi "Kempeleen valaistusurakka", :urakkanro "valai1"} {:id 20, :nimi "Tievalaistuksen palvelusopimus 2015-2020", :urakkanro "TIEVALAISTUS"} {:id 13, :nimi "Oulun valaistuksen palvelusopimus 2013-2050", :urakkanro "9991"})}
                                 {:tyyppi :paallystys, :hallintayksikko {:id 6, :nimi "Varsinais-Suomi", :elynumero 2}, :urakat ({:id 11, :nimi "Porintien päällystysurakka", :urakkanro "PORI"})}
                                 {:tyyppi :tiemerkinta, :hallintayksikko {:id 7, :nimi "Kaakkois-Suomi", :elynumero 3}, :urakat ({:id 18, :nimi "Tiemerkintöjen palvelusopimus KAS ELY 2013 - 2017", :urakkanro "TIE600"})}
                                 {:tyyppi :hoito, :hallintayksikko {:id 8, :nimi "Pirkanmaa", :elynumero 4}, :urakat ({:id 25, :nimi "Tampereen alueurakka 2017-2022", :urakkanro "tre123"})}
                                 {:tyyppi :paikkaus, :hallintayksikko {:id 12, :nimi "Pohjois-Pohjanmaa", :elynumero 12}, :urakat ({:id 9, :nimi "YHA-paikkausurakka", :urakkanro "YHA2"} {:id 17, :nimi "Muhoksen paikkausurakka", :urakkanro "muho2"})}
                                 {:tyyppi :tiemerkinta, :hallintayksikko {:id 13, :nimi "Lappi", :elynumero 14}, :urakat ({:id 38, :nimi "Lapin tiemerkintäurakka", :urakkanro "TIEM1"} {:id 15, :nimi "Lapin tiemerkinnän palvelusopimus 2013-2018", :urakkanro "LAPPI123"})}
                                 {:tyyppi :tiemerkinta, :hallintayksikko {:id 8, :nimi "Pirkanmaa", :elynumero 4}, :urakat ({:id 14, :nimi "Pirkanmaan tiemerkinnän palvelusopimus 2013-2018", :urakkanro "tiem1"})}
                                 ...
                                 {:tyyppi :vesivayla-hoito, :hallintayksikko {:id 3, :nimi "Meriväylät", :elynumero nil}, :urakat ({:id 41, :nimi "Vantaan väyläyksikön väylänhoito ja -käyttö, Itäinen SL", :urakkanro "1"}
                                                                                                                                   {:id 42, :nimi "Helsingin väyläyksikön väylänhoito ja -käyttö, Itäinen SL", :urakkanro "2"})}
                                 {:tyyppi :vesivayla-hoito, :hallintayksikko {:id 2, :nimi "Sisävesiväylät", :elynumero nil}, :urakat ({:id 46, :nimi "Rentoselän urakka", :urakkanro "4"}
                                                                                                                                       {:id 45, :nimi "Pyhäselän urakka", :urakkanro "3"})}
                                 {:tyyppi :tekniset-laitteet, :hallintayksikko {:id 8, :nimi "Pirkanmaa", :elynumero 4}, :urakat ({:id 30, :nimi "PIR RATU IHJU", :urakkanro "3007"})}
                                 {:tyyppi :paallystys, :hallintayksikko {:id 5, :nimi "Uusimaa", :elynumero 1}, :urakat ({:id 6, :nimi "Porvoon päällystysurakka", :urakkanro "por1"})}
                                 {:tyyppi :hoito, :hallintayksikko {:id 5, :nimi "Uusimaa", :elynumero 1}, :urakat ({:id 22, :nimi "Vantaan alueurakka 2009-2019", :urakkanro "131"}
                                                                                                                    {:id 40 :nimi "UUD Raasepori  MHU 2021- 2026, P" :urakkanro "928"}
                                                                                                                    {:id 23, :nimi "Espoon alueurakka 2014-2019", :urakkanro "130"})}
                                 {:tyyppi :siltakorjaus, :hallintayksikko {:id 7, :nimi "Kaakkois-Suomi", :elynumero 3}, :urakat ({:id 29, :nimi "KAS siltojen ylläpidon palvelusopimus Etelä-Karjala", :urakkanro "5003"})}
                                 {:tyyppi :hoito, :hallintayksikko {:id 6, :nimi "Varsinais-Suomi", :elynumero 2}, :urakat ({:id 3, :nimi "Porin alueurakka 2007-2012", :urakkanro "pori666"})}
                                 {:tyyppi :paallystys, :hallintayksikko {:id 13, :nimi "Lappi", :elynumero 14}, :urakat ({:id 37, :nimi "Kemin päällystysurakka", :urakkanro "LAP1"})}
                                 {:tyyppi :vesivayla-kanavien-hoito, :hallintayksikko {:id 1, :nimi "Kanavat ja avattavat sillat", :elynumero nil}, :urakat ({:id 47, :nimi "Saimaan kanava", :urakkanro "089123"}
                                                                                                                                                             {:id 48, :nimi "Joensuun kanava", :urakkanro "089123"})}
                                 {:tyyppi :tiemerkinta, :hallintayksikko {:id 12, :nimi "Pohjois-Pohjanmaa", :elynumero 12}, :urakat ({:id 12, :nimi "Oulun tiemerkinnän palvelusopimus 2013-2022", :urakkanro "OULU_TIE"})})]
