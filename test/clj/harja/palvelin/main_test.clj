...
(def halutut-komponentit
  #{:metriikka
    ...
    :indeksit :urakat :urakan-toimenpiteet :yksikkohintaiset-tyot :kokonaishintaiset-tyot :budjettisuunnittelu
    :muut-tyot :toteumat :laskut :yllapitototeumat :paallystys :maaramuutokset :paikkaus
