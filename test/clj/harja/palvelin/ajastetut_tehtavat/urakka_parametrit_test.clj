...
(deftest varmista-urakka-parametrit
  (let [kittila-urakka-id (hae-urakan-id-nimella "Kittilän MHU 2019-2024")
        ...
        bonusprosentti-yli-2024 0.08M ;; -25 alkuisia urakoita ei ole vielä
        sanktioprosentti-tasan-alle-2024 0.33M
        sanktioprosentti-yli-2024 0.18M ;; -25 alkuisia urakoita ei ole vielä
        tavoitepalkkion-maksuprosentti-tasan-alle-2024 30M
        tavoitepalkkion-maksuprosentti-yli-2024 75M ;; -25 alkuisia urakoita ei ole vielä
        ...
        tavoitehinnan-ylityksen-urakoitsijan-maksuprosentti-yli-2024 75M ;; -25 alkuisia urakoita ei ole vielä
        tavoitehinnan-ylityksen-tilaajan-maksuprosentti-yli-2024 25M ;; -25 alkuisia urakoita ei ole vielä
        kattohinnan-siirron-prosenttirajoitus-tasan-alle-2024 nil
        kattohinnan-siirron-prosenttirajoitus-yli-2024 0.03M ;; -25 alkuisia urakoita ei ole vielä
        ...
        hoitokauden-lopun-kattohinta-kerroin-yli-2024 1.2M  ;; -25 urakoita ei ole vielä
        ...
        _ (is (= (:lupauspaatoksen_bonusprosentti kajaani-parametrit) bonusprosentti-tasan-alle-2024))
        _ (is (= (:lupauspaatoksen_sanktioprosentti ii-parametrit) sanktioprosentti-tasan-alle-2024))
        _ (is (= (:lupauspaatoksen_sanktioprosentti kajaani-parametrit) sanktioprosentti-tasan-alle-2024))
        _ (is (= (:tavoitepalkkion_maksuprosentti ii-parametrit) tavoitepalkkion-maksuprosentti-tasan-alle-2024))
        _ (is (= (:tavoitepalkkion_maksuprosentti kajaani-parametrit) tavoitepalkkion-maksuprosentti-tasan-alle-2024))
        ...
        _ (is (= (:kattohintaylityksen_siirron_prosenttirajoitus kajaani-parametrit) kattohinnan-siirron-prosenttirajoitus-tasan-alle-2024))
        ...
        _ (is (= (:hoitokauden_lopun_kattohinta_kerroin kajaani-parametrit) hoitokauden-lopun-kattohinta-kerroin-tasan-alle-2024))
