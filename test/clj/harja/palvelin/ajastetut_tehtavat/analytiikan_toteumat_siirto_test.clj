...
(deftest siirra-analytiikan-toteumat-toimii-vuodelle-2015
  (let [testitietokanta (:db jarjestelma)
        ...
        siirretty (first (q "SELECT luotu, toteumamateriaalit, toteumatehtavat FROM analytiikka_toteumat WHERE toteuma_tunniste_id = '1117'"))
    ...
    (is (not (nil? (:f8 toteumatahtavat))) "Toteuman tehtäväriviltä löytyy luontiakaileima.")
    ...
    (is (= false (:f7 toteumatahtavat)) "Toteumatehtävän poistettu-tieto löytyy ja on oikein.")
