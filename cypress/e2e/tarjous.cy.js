...
describe('Tarjous-näkymä', function () {
    ...
    describe('Perustoiminnallisuus 2024 urakalle', function () {

        beforeEach(function () {
            avaaTarjousNakyma('Ivalon MHU testiurakka (uusi)', 'Lappi');
        });
    ...
    describe('Perustoiminnallisuus 2021 urakalle', function () {
    ...
    describe('Erillishankinnat-gridin testit 2024 urakalle', function () {
        ...
        it('Erillishankinnat tallennus toimii', function () {
            ...
            tarkistaTarjousRivinTextArvo('tarjous-erillishankinnat-grid', 'Erillishankinnat', 4, '2 500,00');
        });
    });

    describe('Hoidonjohtopalkkio-gridin testit 2024 urakalle', function () {

        beforeEach(function () {
            avaaTarjousNakyma('Ivalon MHU testiurakka (uusi)', 'Lappi');
        });

        it('Hoidonjohtopalkkio-grid näkyy oikein', function () {
            // Tarkista että Hoidonjohtopalkkio-taulukko näkyy
            cy.get('.grid').should('contain', 'Hoidonjohtopalkkio');

            // Tarkista että € / hoitovuosi kenttä on muokattavissa
            cy.contains('tbody tr', 'Hoidonjohtopalkkio')
                .find('input[type="text"]')
                .should('be.visible')
                .should('not.be.disabled');
        });

        it('Hoidonjohtopalkkio tallennus toimii', function () {
            const eperhoitovuosiArvo = '2500';

            // Muokkaa hoidonjohtopalkkion arvoa
            muokkaaTarjousRiviaArvo('tarjous-hoidonjohtopalkkio-grid', 'Hoidonjohtopalkkio', 0, eperhoitovuosiArvo);
            ...
            // Varmista että tallennettu arvo säilyy
            tarkistaTarjousRivinTextArvo('tarjous-hoidonjohtopalkkio-grid', 'Hoidonjohtopalkkio', 4, '2 500,00');
        });
    });

    describe('Johto- ja hallintokorvaus-gridin testit 2021 urakalle', function () {
        ...
        it('Johto- ja hallintokorvaus-grid näkyy oikein', function () {
            ...
            cy.contains('Iin MHU 2021-2026').should('be.visible');
            cy.wait('@hae-tarjous');
        ...
        it('Johto- ja hallintokorvaus tallennus toimii', function () {
            ...
            asetaToimenkuvalleArvo('Sopimusvastaava', 1000, 2000, 3000, 4000, 5000);
            asetaToimenkuvalleArvo('Vastuunalainen työnjohtaja', 1000, 2000, 3000, 4000, 5000);
            asetaToimenkuvalleArvo('Päätoiminen apulainen (talvikausi)', 1000, 2000, 3000, 4000, 5000);
            asetaToimenkuvalleArvo('Päätoiminen apulainen (kesäkausi)', 1000, 2000, 3000, 4000, 5000);
            asetaToimenkuvalleArvo('Apulainen/työnjohtaja (talvikausi)', 1000, 2000, 3000, 4000, 5000);
            asetaToimenkuvalleArvo('Apulainen/työnjohtaja (kesäkausi)', 1000, 2000, 3000, 4000, 5000);
            ...
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().contains('9 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().contains('18 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().next().contains('27 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().next().next().contains('36 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().next().next().next().contains('45 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().next().next().next().next().contains('135 000,00');
    ...
    describe('Johto- ja hallintokorvaus-gridin testit 2024 urakalle', function () {
        ...
        it('Johto- ja hallintokorvaus tallennus toimii', function () {
            ...
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().contains('5 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().contains('10 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().next().contains('15 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().next().next().contains('20 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().next().next().next().contains('25 000,00');
            cy.get('[data-cy=tarjous-toimenkuvat-grid] table.grid tbody').contains('Johto- ja hallintokorvaus yhteensä').next().next().next().next().next().next().next().contains('75 000,00');
