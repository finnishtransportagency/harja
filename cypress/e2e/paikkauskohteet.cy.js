...
describe('Paikkaustoteumat toimii', function () {
    ...
    it('Poistetaan toteuma', () => {
        ...
        cy.get('[data-cy="harja-modal"]', {timeout: clickTimeout}).should('be.visible')
        cy.get('[data-cy="harja-modal"]').contains('Poista toteuma').click()
        cy.get('[data-cy="harja-modal"]', {timeout: clickTimeout}).should('not.exist')
